  ...
  function (a) {
    ...
    e.prototype.forEach = function (k, f) {
      for (var h = this.entries(), q; !(q = h.next()).done;)
        (q = q.value), k.call(f, q[1], q[0], this);
    };
      ...
      if (q && $jscomp.owns(k.data_, h))
        for (k = 0; k < q.length; k++) {
          ...
          if ((f !== f && t.key !== t.key) || f === t.key)
            return { id: h, list: q, index: k, entry: t };
        }
...
$jscomp.polyfill(
  ...
  function (a) {
    ...
    d.race = function (g) {
      return new d(function (p, k) {
        for (
          var f = $jscomp.makeIterator(g), h = f.next();
          !h.done;
          h = f.next()
        )
          c(h.value).callWhenSettled_(p, k);
      });
    };
    d.all = function (g) {
      ...
      return k.done
        ...
        : new d(function (f, h) {
          ...
          do
            t.push(void 0),
              r++,
              c(k.value).callWhenSettled_(q(t.length - 1), h),
              (k = p.next());
          while (!k.done);
        });
    };
  ...
  if (void 0 != a) {
    ...
    if (/^(rgb|RGB)/.test(a)) {
      ...
      for (var c = a.next(); !c.done; c = a.next())
        b.push(Number((Number(c.value) / 255).toFixed(1)));
    } else if (/^#/.test(a)) {
...
var AcApiVersion = "r5.0.500",
  ...
  AirCityAPI = function (a, b, c) {
    ...
    "function" == typeof b
      ? ((this.onReadyCall = b), "function" == typeof c && (this.fnLog = c))
      : "object" == typeof b &&
      ((this.onReadyCall = b.onReady),
        (this.eventCall = b.onEvent),
        (this.fnLog = b.onLog),
        (this.useColorLog = b.useColorLog),
        (this.onApiVersionReceived = b.onApiVersion),
        (this.player = b.player) && (this.player.aircityApi = this));
    this.player ||
      ((b = a.split("-")),
        (this.url =
          4 == b.length
            ? "ws://" + AirCityAPI._int2ip(b[0]) + ":" + b[3]
            : "ws://" + a),
        this.initWebSocket());
    this.initInterface();
  };
...
AirCityAPI.prototype.call = function (a, b) {
  ...
  if (!this.isConnected)
    return (
      this.logWithColor("red", "Not connected!"),
      b ? void 0 : Promise.reject("Not connected!")
    );
  if (void 0 == a.command || a.command == CommandType.None)
    return (
      this.logWithColor("red", "command is undefined or None"),
      b ? void 0 : Promise.reject("command is undefined or None")
    );
  ...
  this.logWithColor(
    "RoyalBlue",
    "Request: " + (CommandType[a.command] || "Unknown"),
    !0
  );
  this.logWithColor(
    "green",
  ...
  if (b) this.player ? this.player.sendApiCommand(a) : this.webSocket.send(d);
  else
    return new Promise(function (l) {
      c.callbackMap[e] = l;
      c.player ? c.player.sendApiCommand(a) : c.webSocket.send(d);
    });
};
...
AirCityAPI.prototype.logWithColor = function (a, b, c) {
  this.fnLog &&
    (this.useColorLog
      ? this.log("<font color='" + a + "'>" + b + "</font>", c)
      : this.log(b, c));
};
AirCityAPI.prototype.onConnectionOpen = function () {
  this.isConnected = !0;
...
AirCityAPI.prototype.onConnectionClose = function (a) {
  ...
  this.logWithColor(
    ...
    (a.code || "-") +
    ", reason: " +
    (1006 == a.code ? "close abnormal" : a.reason || "-")
  );
  this.log("");
  this.logWithColor("SpringGreen", "Reconnecting...");
  this.isDestroyed || this.player || this.reconnect();
};
AirCityAPI.prototype.onConnectionMessage = function (a) {
  ...
  b.command
    ? ((c = Date.now() - b.timestamp),
      this.logWithColor(
        "RoyalBlue",
        "Response: " + (CommandType[b.command] || "Unknown"),
        !0
      ),
      this.logWithColor("green", "\uff08\u8017\u65f6\uff1a" + c + "ms\uff09"),
      this.logWithColor(
        "gray",
        "\u8bf7\u6c42\u65f6\u95f4\uff1a" +
    ...
    : b.eventtype
      ...
      : this.log("Response: [Unknown]");
  this.logWithColor("gray", a);
  a = b.command + "_" + b.callbackIndex;
  if ((c = this.callbackMap[a])) c(b), delete this.callbackMap[a];
  if (b.eventtype)
    if ("CompleteInitialization" == b.eventtype)
      this.log(
        "The initialization is complete, now you can call the interfaces in onReady callback function."
      ),
        this.onReady();
    else this.onEvent(b);
};
    ...
    ("WebSocket" in window
      ? (this.log("Connecting: " + this.url),
        ...
        (this.webSocket.onmessage = function (a) {
          this.onConnectionMessage(a.data);
        }.bind(this)),
...
AirCityAPI.prototype.initInterface = function () {
  ...
  this.floodFill = new AirCityAPI.FloodFill(this);
  this.cesium3DTile = new AirCityAPI.Cesium3DTile(this);
...
AirCityAPI.Camera.prototype.set = function (a, b, c, e, d, l, g) {
  ...
  if ("object" == typeof a && a.hasOwnProperty("x"))
    return this._setByObject(a, b, c);
  ...
  return this.int.call(
    {
      command: CommandType.Camera_Set,
      coordinate: [a, b, c],
      pitch: e || 0,
      yaw: d || 0,
      flyTime: l,
...
AirCityAPI.Camera.prototype.lookAtBBox = function (a, b, c, e, d) {
  ...
  return this.int.call(
    {
      command: CommandType.Camera_LookAtBBox,
      bbox: a,
      pitch: b || 0,
      yaw: c || 0,
      flyTime: e,
...
AirCityAPI.Camera.prototype.moveForward = function (a) {
  return this.int.call(
    { command: CommandType.Camera_Move, moveForward: !0 },
    a
  );
};
AirCityAPI.Camera.prototype.moveBackward = function (a) {
  return this.int.call(
    { command: CommandType.Camera_Move, moveBackward: !0 },
    a
  );
};
...
AirCityAPI.Coord.prototype.screen2World = function (a, b, c) {
  return this.int.call(
    { command: CommandType.Coord_Screen2World, screenPosition: [a, b] },
    c
  );
};
AirCityAPI.Coord.prototype.world2Screen = function (a, b, c, e) {
  return this.int.call(
    { command: CommandType.Coord_World2Screen, worldlocation: [a, b, c] },
    e
  );
};
AirCityAPI.Coord.prototype.gcs2pcs = function (a, b) {
  return this.int.call(
    {
      command: CommandType.Coord_GCS2PCS,
      coordinates: __convertCoordinates(a),
    },
    b
  );
};
AirCityAPI.Coord.prototype.pcs2gcs = function (a, b) {
  return this.int.call(
    {
      command: CommandType.Coord_PCS2GCS,
      coordinates: __convertCoordinates(a),
    },
    b
  );
...
AirCityAPI.InfoTree.prototype.setVisibility = function (a, b) {
  return this.int.call(
    {
      command: CommandType.InfoTree_SetVisibility,
      layers: this.int.makeArray(a),
    },
    b
  );
};
AirCityAPI.InfoTree.prototype.show = function (a, b) {
  return this.int.call(
    { command: CommandType.InfoTree_Show, ids: this.int.makeStringArray(a) },
    b
  );
};
AirCityAPI.InfoTree.prototype.hide = function (a, b) {
  return this.int.call(
    { command: CommandType.InfoTree_Hide, ids: this.int.makeStringArray(a) },
    b
  );
};
AirCityAPI.InfoTree.prototype.enableXRay = function (a, b, c) {
  return this.int.call(
    {
      command: CommandType.InfoTree_EnableXRay,
      ids: this.int.makeArray(a),
      color: b,
    },
    c
  );
...
AirCityAPI.InfoTree.prototype.disableXRay = function (a, b) {
  return this.int.call(
    { command: CommandType.InfoTree_DisableXRay, ids: this.int.makeArray(a) },
    b
  );
};
AirCityAPI.InfoTree.prototype.showByGroupId = function (a, b) {
  return this.int.call(
    {
      command: CommandType.InfoTree_ShowByGroupId,
      ids: this.int.makeStringArray(a),
    },
    b
  );
};
AirCityAPI.InfoTree.prototype.hideByGroupId = function (a, b) {
  return this.int.call(
    {
      command: CommandType.InfoTree_HideByGroupId,
      ids: this.int.makeStringArray(a),
    },
    b
  );
...
AirCityAPI.InfoTree.prototype.highlightByGroupId = function (a, b) {
  return this.int.call(
    {
      command: CommandType.InfoTree_HighlightByGroupId,
      ids: this.int.makeStringArray(a),
    },
    b
  );
...
AirCityAPI.InfoTree.prototype.deleteByGroupId = function (a, b) {
  return this.int.call(
    {
      command: CommandType.InfoTree_DeleteByGroupId,
      ids: this.int.makeStringArray(a),
    },
    b
  );
...
AirCityAPI.Object.prototype._processProps = function (a) {
  ...
  if (this.colorProps)
    for (
      b = this.colorProps.split("|"), e = $jscomp.makeIterator(a), c = e.next();
      !c.done;
      c = e.next()
    ) {
      c = c.value;
      for (var d = $jscomp.makeIterator(b), l = d.next(); !l.done; l = d.next())
        (l = l.value), c.hasOwnProperty(l) && (c[l] = __convertColor(c[l]));
    }
  if (
    "Polygon" == this.type ||
    "Polygon3D" == this.type ||
    "HighlightArea" == this.type ||
    "DynamicWater" == this.type
  )
    for (a = $jscomp.makeIterator(a), c = a.next(); !c.done; c = a.next())
      (b = c.value),
        (b.coordinates = __convertCoordinatesForParts(b.coordinates));
};
AirCityAPI.Object.prototype._add = function (a, b) {
  this._processProps(a);
  return this.int.call(
    { command: this._checkCommand("_Add"), data: this.int.makeArray(a) },
    b
  );
};
AirCityAPI.Object.prototype._update = function (a, b) {
  this._processProps(a);
  return this.int.call(
    { command: this._checkCommand("_Update"), data: this.int.makeArray(a) },
    b
  );
};
...
AirCityAPI.Object.prototype._get = function (a, b) {
  return this.int.call(
    { command: this._checkCommand("_Get"), ids: this.int.makeStringArray(a) },
    b
  );
};
...
AirCityAPI.Object.prototype._show = function (a, b) {
  return this.int.call(
    { command: this._checkCommand("_Show"), ids: this.int.makeStringArray(a) },
    b
  );
};
...
AirCityAPI.Object.prototype._hide = function (a, b) {
  return this.int.call(
    { command: this._checkCommand("_Hide"), ids: this.int.makeStringArray(a) },
    b
  );
};
...
AirCityAPI.Object.prototype._updateOneProp = function (a, b, c, e) {
  if (this._useBatchUpdate) {
    e = !1;
    for (
      var d = $jscomp.makeIterator(this._tempUpdateData), l = d.next();
      !l.done;
      l = d.next()
    )
...
AirCityAPI.CameraTour.prototype.play = function (a, b) {
  return this.int.call(
    { command: CommandType.CameraTour_Play, ids: this.int.makeStringArray(a) },
    b
  );
};
...
AirCityAPI.CameraTour.prototype.stop = function (a, b) {
  return this.int.call(
    { command: CommandType.CameraTour_Stop, ids: this.int.makeStringArray(a) },
    b
  );
};
AirCityAPI.CameraTour.prototype.setUserData = function (a, b, c) {
  return AirCityAPI.Object.prototype._updateOneProp.call(
    this,
    a,
    "userData",
    b,
...
AirCityAPI.TileLayer.prototype.enableXRay = function (a, b, c) {
  return this.int.call(
    {
      command: CommandType.TileLayer_EnableXRay,
      ids: this.int.makeStringArray(a),
      color: b,
    },
    c
...
AirCityAPI.TileLayer.prototype.disableXRay = function (a, b) {
  return this.int.call(
    {
      command: CommandType.TileLayer_DisableXRay,
      ids: this.int.makeStringArray(a),
    },
    b
  );
...
AirCityAPI.TileLayer.prototype.enableClip = function (a, b) {
  ...
  for (var e = a.next(); !e.done; e = a.next())
    c.push({ id: e.value, allowClip: !0 });
  return this.int.call(
    { command: CommandType.TileLayer_SetAllowClip, data: c },
    b
  );
};
...
AirCityAPI.TileLayer.prototype.setTranslation = function (a, b, c) {
...
AirCityAPI.TileLayer.prototype.showActors = function (a, b) {
  return this.int.call(
    { command: CommandType.TileLayer_Actor_Show, data: this.int.makeArray(a) },
    b
  );
};
...
AirCityAPI.TileLayer.prototype.hideActors = function (a, b) {
  return this.int.call(
    { command: CommandType.TileLayer_Actor_Hide, data: this.int.makeArray(a) },
    b
  );
};
...
AirCityAPI.TileLayer.prototype.focusActors = function (a, b) {
  return this.int.call(
    { command: CommandType.TileLayer_Actor_Focus, data: this.int.makeArray(a) },
    b
  );
};
...
AirCityAPI.TileLayer.prototype.highlightActors = function (a, b) {
  return this.int.call(
    {
      command: CommandType.TileLayer_Actor_Highlight,
      data: this.int.makeArray(a),
    },
    b
  );
};
...
AirCityAPI.TileLayer.prototype.stopHighlightActors = function (a, b) {
  ...
  return c
    ? this.int.call0(CommandType.TileLayer_Actor_StopHightlight, b)
    : this.int.call(
      {
        command: CommandType.TileLayer_Actor_Unhighlight,
        data: this.int.makeArray(a),
      },
      b
    );
...
AirCityAPI.TileLayer.prototype.showAllActors = function (a, b) {
  return this.int.call(
    {
      command: CommandType.TileLayer_Actor_ShowAll,
      ids: this.int.makeStringArray(a),
    },
    b
  );
...
AirCityAPI.TileLayer.prototype.hideAllActors = function (a, b) {
  return this.int.call(
    {
      command: CommandType.TileLayer_Actor_HideAll,
      ids: this.int.makeStringArray(a),
    },
    b
  );
...
AirCityAPI.TileLayer.prototype.setStyle = function (a, b, c, e) {
  return this.int.call(
    {
      command: CommandType.TileLayer_SetStyle,
      ids: this.int.makeStringArray(a),
      style: b,
      color: __convertColor(c),
    },
    e
  );
};
AirCityAPI.TileLayer.prototype.setCollision = function (a, b, c) {
  ...
  for (var d = a.next(); !d.done; d = a.next())
    e.push({ id: d.value, enableCollision: b });
  return this.int.call(
    { command: CommandType.TileLayer_SetCollision, data: e },
    c
  );
};
AirCityAPI.TileLayer.prototype.addModifier = function (a, b, c, e, d) {
  return this.int.call(
    {
      command: CommandType.TileLayer_Modifier_Add,
      id: a,
      tileLayerId: b,
      coordinates: c,
      ententBufferSize: e,
...
AirCityAPI.TileLayer.prototype.updateModifier = function (a, b, c, e, d) {
  return this.int.call(
    {
      command: CommandType.TileLayer_Modifier_Update,
      id: a,
      tileLayerId: b,
      coordinates: c,
      ententBufferSize: e,
...
AirCityAPI.TileLayer.prototype.deleteModifier = function (a, b, c) {
  return this.int.call(
    { command: CommandType.TileLayer_Modifier_Delete, id: a, tileLayerId: b },
    c
  );
};
AirCityAPI.TileLayer.prototype.clearModifier = function (a, b) {
  return this.int.call(
    {
      command: CommandType.TileLayer_Modifier_Clear,
      ids: this.int.makeStringArray(a),
    },
    b
  );
...
AirCityAPI.TileLayer.prototype.setViewportVisible = function (a, b, c) {
  ...
  return this.int.call(
    { command: CommandType.TileLayer_SetViewportVisible, id: a, data: e },
    c
  );
};
AirCityAPI.TileLayer.prototype.getObjectIDs = function (a, b) {
  return this.int.call(
    {
      command: CommandType.TileLayer_GetObjectIDs,
      ids: this.int.makeStringArray(a),
    },
    b
  );
...
AirCityAPI.Tag = function (a) {
  AirCityAPI.Object.call(
    this,
    a,
    "Tag",
    "textColor|textBackgroundColor|textBorderColor"
  );
};
...
AirCityAPI.Tag.prototype.showPopupWindow = function (a, b) {
  return this.int.call(
    {
      command: CommandType.Tag_PopupWindow_Show,
      ids: this.int.makeStringArray(a),
    },
    b
  );
...
AirCityAPI.Tag.prototype.hidePopupWindow = function (a, b) {
  return this.int.call(
    {
      command: CommandType.Tag_PopupWindow_Hide,
      ids: this.int.makeStringArray(a),
    },
    b
  );
...
AirCityAPI.Marker = function (a) {
  AirCityAPI.Object.call(
    ...
    a,
    "Marker",
    "fontColor|fontOutlineColor|textBackgroundColor|lineColor"
  );
};
...
AirCityAPI.Marker.prototype._fixMarkerData = function (a) {
  if (a instanceof Array) {
    ...
    for (var b = a.next(); !b.done; b = a.next())
      this._fixMarkerProperty(b.value);
...
AirCityAPI.Marker.prototype.showPopupWindow = function (a, b) {
  return this.int.call(
    {
      command: CommandType.Marker_ShowPopupWindow,
      ids: this.int.makeStringArray(a),
    },
    b
  );
...
AirCityAPI.Marker.prototype.hidePopupWindow = function (a, b) {
  return this.int.call(
    {
      command: CommandType.Marker_HidePopupWindow,
      ids: this.int.makeStringArray(a),
    },
    b
  );
...
AirCityAPI.Marker.prototype.setOcclusionCull = function (a, b, c) {
  return AirCityAPI.Object.prototype._updateOneProp.call(
    this,
    a,
    "occlusionCull",
...
AirCityAPI.RadiationPoint.prototype.setAutoHeight = function (a, b, c) {
  return AirCityAPI.Object.prototype._updateOneProp.call(
    this,
    a,
    "autoHeight",
...
AirCityAPI.Polygon3D.prototype.highlight = function (a, b) {
  return this.int.call(
    {
      command: CommandType.Polygon3D_Highlight,
      ids: this.int.makeStringArray(a),
    },
    b
  );
};
AirCityAPI.Polygon3D.prototype.stopHighlight = function (a, b) {
  return this.int.call(
    {
      command: CommandType.Polygon3D_StopHighlight,
      ids: this.int.makeStringArray(a),
    },
    b
  );
...
AirCityAPI.Polygon3D.prototype.glow = function (a, b, c) {
  return this.int.call(
    {
      command: CommandType.Polygon3D_Glow,
      ids: this.int.makeStringArray(a),
      duration: b,
    },
    c
...
AirCityAPI.Polygon3D.prototype.stopGlow = function (a, b) {
  return this.int.call(
    { command: CommandType.Polygon3D_Glow, ids: this.int.makeStringArray(a) },
    b
  );
};
...
AirCityAPI.Polygon.prototype.glow = function (a, b, c) {
  return this.int.call(
    {
      command: CommandType.Polygon_Glow,
      ids: this.int.makeStringArray(a),
      duration: b,
    },
    c
...
AirCityAPI.Polygon.prototype.highlight = function (a, b) {
  return this.int.call(
    {
      command: CommandType.Polygon_Hightlight,
      ids: this.int.makeStringArray(a),
    },
    b
  );
...
AirCityAPI.HeatMap.prototype.add = function (a, b, c, e, d) {
  return this._checkBBox(b)
    ? this.int.call(
      {
        command: CommandType.HeatMap_Add,
        id: a.toString(),
        bbox: b,
        range: c,
        data: this.int.makeArray(e),
      },
      d
    )
    : (this.int.logWithColor("red", "Invalid bbox value"), !1);
};
AirCityAPI.HeatMap.prototype.update = function (a, b, c, e, d) {
  a = { command: CommandType.HeatMap_Update, id: a.toString() };
  if (b) {
    if (!this._checkBBox(b))
      return this.int.logWithColor("red", "Invalid bbox value"), !1;
    a.bbox = b;
  }
  c && (a.range = c);
...
AirCityAPI.HeatMap.prototype.addPoints = function (a, b, c) {
  return this.int.call(
    {
      command: CommandType.HeatMap_AddPoints,
      id: a,
      data: this.int.makeArray(b),
    },
    c
  );
};
AirCityAPI.HeatMap.prototype.removePoints = function (a, b, c) {
  return this.int.call(
    {
      command: CommandType.HeatMap_RemovePoints,
      id: a,
      pointIds: this.int.makeArray(b),
    },
    c
  );
};
AirCityAPI.HeatMap.prototype.setRange = function (a, b, c) {
  return this.int.call(
    { command: CommandType.HeatMap_Update, id: a, range: b },
    c
  );
};
AirCityAPI.HeatMap.prototype.setBBox = function (a, b, c) {
  return this._checkBBox(bbox)
    ? this.int.call({ command: CommandType.HeatMap_Update, id: a, bbox: b }, c)
    : (this.int.logWithColor("red", "Invalid bbox value"), !1);
};
...
AirCityAPI.CustomObject.prototype.addByTileLayer = function (a, b) {
  return this.int.call(
    {
      command: CommandType.CustomObject_AddByTileLayer,
      data: this.int.makeArray(a),
    },
    b
  );
...
AirCityAPI.CustomObject.prototype.highlight = function (a, b, c) {
  return this.int.call(
    {
      command: CommandType.CustomObject_Highlight,
      ids: this.int.makeStringArray(a),
      color: __convertColor(b),
    },
    c
  );
};
AirCityAPI.CustomObject.prototype.unhighlight = function (a, b) {
  return "undefined" == typeof a || "function" == typeof a
    ? ("function" == typeof a && (b = a),
      this.int.call({ command: CommandType.CustomObject_StopHighlight }, b))
    : this.int.call(
      {
        command: CommandType.CustomObject_Unhighlight,
        ids: this.int.makeStringArray(a),
      },
      b
    );
...
AirCityAPI.CustomObject.prototype.callFunction = function (a, b, c, e, d) {
  return this.int.call(
    {
      command: CommandType.CustomObject_CallFunction,
      data: this.int.makeArray({
        id: a.toString(),
        functionName: b,
        paramType: c,
        paramValue: e,
...
AirCityAPI.VideoProjection.prototype.setDepthCulling = function (a, b, c) {
  return AirCityAPI.Object.prototype._updateOneProp.call(
    this,
    a,
    "depthCulling",
...
AirCityAPI.VideoProjection.prototype.setFrustumColor = function (a, b, c) {
  return AirCityAPI.Object.prototype._updateOneProp.call(
    this,
    a,
    "frustumColor",
...
AirCityAPI.FloodFill = function (a) {
  AirCityAPI.Object.call(this, a, "FloodFill", "color");
};
$jscomp.inherits(AirCityAPI.FloodFill, AirCityAPI.Object);
AirCityAPI.FloodFill.prototype.add = function (a, b) {
  return AirCityAPI.Object.prototype._add.call(this, a, b);
};
AirCityAPI.FloodFill.prototype.update = function (a, b) {
  return AirCityAPI.Object.prototype._update.call(this, a, b);
};
AirCityAPI.FloodFill.prototype.delete = function (a, b) {
  return AirCityAPI.Object.prototype._delete.call(this, a, b);
};
AirCityAPI.FloodFill.prototype.clear = function (a) {
  return AirCityAPI.Object.prototype._clear.call(this, a);
};
AirCityAPI.FloodFill.prototype.focus = function (a, b, c, e) {
  return AirCityAPI.Object.prototype._focus.call(this, a, b, c, e);
};
AirCityAPI.FloodFill.prototype.show = function (a, b) {
  return AirCityAPI.Object.prototype._show.call(this, a, b);
};
AirCityAPI.FloodFill.prototype.showAll = function (a) {
  return AirCityAPI.Object.prototype._showAll.call(this, a);
};
AirCityAPI.FloodFill.prototype.hide = function (a, b) {
  return AirCityAPI.Object.prototype._hide.call(this, a, b);
};
AirCityAPI.FloodFill.prototype.hideAll = function (a) {
  return AirCityAPI.Object.prototype._hideAll.call(this, a);
};
AirCityAPI.FloodFill.prototype.get = function (a, b) {
  return AirCityAPI.Object.prototype._get.call(this, a, b);
};
AirCityAPI.FloodFill.prototype.setMin = function (a, b, c) {
  return AirCityAPI.Object.prototype._updateOneProp.call(this, a, "min", b, c);
};
AirCityAPI.FloodFill.prototype.setMax = function (a, b, c) {
  return AirCityAPI.Object.prototype._updateOneProp.call(
    this,
    a,
    "max",
...
AirCityAPI.FloodFill.prototype.setSeed = function (a, b, c) {
  return AirCityAPI.Object.prototype._updateOneProp.call(this, a, "seed", b, c);
};
AirCityAPI.FloodFill.prototype.setElevation = function (a, b, c) {
  return AirCityAPI.Object.prototype._updateOneProp.call(
    this,
    a,
    "elevation",
...
AirCityAPI.FloodFill.prototype.setColor = function (a, b, c) {
  return AirCityAPI.Object.prototype._updateOneProp.call(
    this,
    a,
    "color",
...
AirCityAPI.FloodFill.prototype.setPrecision = function (a, b, c) {
  return AirCityAPI.Object.prototype._updateOneProp.call(
    this,
    a,
    "precision",
...
AirCityAPI.Cesium3DTile = function (a) {
  AirCityAPI.Object.call(this, a, "Cesium3DTile");
};
$jscomp.inherits(AirCityAPI.Cesium3DTile, AirCityAPI.Object);
AirCityAPI.Cesium3DTile.prototype.add = function (a, b) {
  return AirCityAPI.Object.prototype._add.call(this, a, b);
};
AirCityAPI.Cesium3DTile.prototype.update = function (a, b) {
  return AirCityAPI.Object.prototype._update.call(this, a, b);
};
AirCityAPI.Cesium3DTile.prototype.delete = function (a, b) {
  return AirCityAPI.Object.prototype._delete.call(this, a, b);
};
AirCityAPI.Cesium3DTile.prototype.clear = function (a) {
  return AirCityAPI.Object.prototype._clear.call(this, a);
};
AirCityAPI.Cesium3DTile.prototype.focus = function (a, b, c, e) {
  return AirCityAPI.Object.prototype._focus.call(this, a, b, c, e);
};
AirCityAPI.Cesium3DTile.prototype.show = function (a, b) {
  return AirCityAPI.Object.prototype._show.call(this, a, b);
};
AirCityAPI.Cesium3DTile.prototype.showAll = function (a) {
  return AirCityAPI.Object.prototype._showAll.call(this, a);
};
AirCityAPI.Cesium3DTile.prototype.hide = function (a, b) {
  return AirCityAPI.Object.prototype._hide.call(this, a, b);
};
AirCityAPI.Cesium3DTile.prototype.hideAll = function (a) {
  return AirCityAPI.Object.prototype._hideAll.call(this, a);
};
AirCityAPI.Cesium3DTile.prototype.get = function (a, b) {
  return AirCityAPI.Object.prototype._get.call(this, a, b);
};
AirCityAPI.Cesium3DTile.prototype.setTileURL = function (a, b, c) {
  return AirCityAPI.Object.prototype._updateOneProp.call(
    this,
    a,
    "tileURL",
...
AirCityAPI.Misc.prototype.addImageButtons = function (a, b) {
  return this.int.call(
    { command: CommandType.Misc_AddImageButton, data: this.int.makeArray(a) },
    b
  );
};
AirCityAPI.Misc.prototype.deleteImageButtons = function (a, b) {
  return this.int.call(
    {
      command: CommandType.Misc_DeleteImageButton,
      ids: this.int.makeStringArray(a),
    },
    b
  );
...
AirCityAPI.Misc.prototype.addAnimatedImageButtons = function (a, b) {
  return this.int.call(
    {
      command: CommandType.Misc_AddAnimatedImageButton,
      data: this.int.makeArray(a),
    },
    b
  );
...
AirCityAPI.Misc.prototype.playVideo = function (a, b, c, e, d, l, g) {
  return this.int.call(
    {
      command: CommandType.Misc_PlayVideo,
      data: [{ id: a.toString(), position: [b, c], size: [e, d], url: l }],
    },
    g
  );
};
AirCityAPI.Misc.prototype.stopPlayVideo = function (a, b) {
  return this.int.call(
    {
      command: CommandType.Misc_StopPlayVideo,
      ids: this.int.makeStringArray(a),
    },
    b
  );
...
AirCityAPI.Misc.prototype.playMovie = function (a, b, c) {
  ...
  return this.int.call(
    { command: CommandType.Misc_PlayMovie, loop: b, url: a },
    c
  );
};
...
AirCityAPI.Misc.prototype.setWindowResolution = function (a, b, c) {
  return this.int.call(
    { command: CommandType.Misc_SetWindowResolution, cx: a, cy: b, mode: 0 },
    c
  );
};
AirCityAPI.Misc.prototype.callBPFunction = function (a, b) {
  return this.int.call(
    { command: CommandType.Misc_CallBPFunction, data: this.int.makeArray(a) },
    b
  );
};
...
AirCityAPI.Misc.prototype.startProcess = function (a, b, c, e) {
  ...
  return this.int.call(
    {
      command: CommandType.Misc_StartProcess,
      appName: a,
      commandLine: b,
      visible: c,
    },
...
AirCityAPI.Misc.prototype.setQueryToolState = function (a, b) {
  return this.int.call(
    { command: CommandType.Settings_SetMousePickMask, mouseClick: a },
    b
  );
};
...
AirCityAPI.Tools.prototype.startPolygonClip = function (a, b, c) {
  return this.int.call(
    {
      command: CommandType.Tools_StartPolygonClip,
      data: this.int.makeArray({
        id: "0",
        toggleImageCut: b,
        coordinates: __convertCoordinatesForParts(a),
      }),
    },
    c
  );
...
AirCityAPI.Tools.prototype.startPlaneClip = function (a, b, c, e) {
  return this.int.call(
    {
      command: CommandType.Tools_StartPlaneClip,
      location: a,
      rotation: b,
      showPlane: c,
    },
...
AirCityAPI.Tools.prototype.startVolumeClip = function (a, b, c) {
  return this.int.call(
    { command: CommandType.Tools_StartVolumeClip, bbox: a, value: b },
    c
  );
};
...
AirCityAPI.Tools.prototype.setMeasurement = function (a, b, c) {
  ...
  return this.int.call(
    {
      command: CommandType.Tools_SetMeasurement,
      type: a,
      lineSize: b.lineSize,
      pointSize: b.pointSize,
      textColor: __convertColor(b.textColor),
      pointColor: __convertColor(b.pointColor),
      lineColor: __convertColor(b.lineColor),
      areaColor: __convertColor(b.areaColor),
...
AirCityAPI.Tools.prototype.lineIntersect = function (a, b, c) {
  return this.int.call(
    { command: CommandType.Tools_LineIntersect, start: a, end: b },
    c
  );
};
AirCityAPI.Tools.prototype.startGeometryEdit = function (a, b) {
  return this.int.call(
    { command: CommandType.Tools_StartGeometryEdit, id: a },
    b
  );
};
...
AirCityAPI.Tools.prototype.startSkylineAnalysis = function (a, b) {
  ...
  if (a.tileLayers) {
    ...
    for (
      var c = $jscomp.makeIterator(a.tileLayers), e = c.next();
      !e.done;
      e = c.next()
    )
      (e = e.value),
        e.hasOwnProperty("color") && (e.color = __convertColor(e.color));
  }
...
AirCityAPI.Tools.prototype.exportSkyline = function (a, b, c, e) {
  ...
  if (c.tileLayers) {
    ...
    for (
      var d = $jscomp.makeIterator(c.tileLayer), l = d.next();
      !l.done;
      l = d.next()
    )
      (l = l.value),
        l.hasOwnProperty("color") && (l.color = __convertColor(l.color));
  }
  return this.int.call(
    {
...
AirCityAPI.Tools.prototype.startFloodFill = function (a, b) {
  a = a || {};
  a.color && (a.color = __convertColor(a.color));
  a.command = CommandType.Tools_StartFloodFill;
  return this.int.call(a, b);
};
AirCityAPI.Tools.prototype.stopFloodFill = function (a) {
  return this.int.call0(CommandType.Tools_StopFloodFill, a);
};
...
AirCityAPI.Settings.prototype.setMapMode = function (a, b, c) {
  ...
  return this.int.call(
    {
      command: CommandType.Settings_SetMapMode,
      mode: a,
...
AirCityAPI.Settings.prototype.setHighlightColor = function (a, b) {
  return this.int.call(
    {
      command: CommandType.Settings_SetHighlightColor,
      color: __convertColor(a),
    },
    b
  );
};
...
AirCityAPI.Settings.prototype.setOceanColor = function (a, b) {
  return this.int.call(
    { command: CommandType.Settings_SetOceanColor, color: a },
    b
  );
};
AirCityAPI.Settings.prototype.setEnableInteract = function (a, b) {
  return this.int.call(
    { command: CommandType.Settings_SetEnableInteract, bEnable: a },
    b
  );
};
AirCityAPI.Settings.prototype.setInteractiveMode = function (a, b) {
  return this.int.call(
    { command: CommandType.Settings_SetInteractiveMode, mode: a },
    b
  );
};
AirCityAPI.Settings.prototype.setCampassVisible = function (a, b) {
  return this.int.call(
    { command: CommandType.Settings_SetCampassVisible, visible: a },
    b
  );
};
AirCityAPI.Settings.prototype.setMainUIVisibility = function (a, b) {
  return this.int.call(
    { command: CommandType.Settings_SetMainUIVisibility, visible: a },
    b
  );
};
AirCityAPI.Settings.prototype.setMousePickMask = function (a, b) {
  ...
  return this.int.call(
    {
      command: CommandType.Settings_SetMousePickMask,
      mouseClick: c,
      mouseMove: e,
      mouseHover: d,
    },
...
AirCityAPI.Settings.prototype.setTerrainAlpha = function (a, b) {
  return this.int.call(
    { command: CommandType.Settings_SetTerrainAlpha, alpha: a },
    b
  );
};
AirCityAPI.Settings.prototype.setEnableCameraMovingEvent = function (a, b) {
  return this.int.call(
    { command: CommandType.Settings_EnableCameraMovingEvent, bEnable: a },
    b
  );
};
...
AirCityAPI.Weather.prototype.setDateTime = function (a, b, c, e, d, l, g) {
  return this.int.call(
    {
      command: CommandType.Weather_SetDate,
      year: a,
      month: b,
      day: c,
      hour: e,
...
AirCityAPI.Weather.prototype.setRainParam = function (a, b, c, e) {
  return this.int.call(
    {
      command: CommandType.Weather_SetParams,
      rainsnow: 0,
      rainsnowStrength: a,
      rainsnowSpeed: b,
      raindropSize: c,
...
AirCityAPI.Weather.prototype.disableRainSnow = function (a) {
  return this.int.call(
    { command: CommandType.Weather_SetParams, rainsnowStrength: 0 },
    a
  );
};
...
AirCityAPI.Weather.prototype.setCloudDensity = function (a, b) {
  return this.int.call(
    { command: CommandType.Weather_SetParams, cloudDensity: a },
    b
  );
};
AirCityAPI.Weather.prototype.setDarkMode = function (a, b) {
  return this.int.call(
    { command: CommandType.Weather_SetParams, darkMode: !!a },
    b
  );
};
...
AirCityAPI.EditHelper.prototype.finish = function (a, b) {
  return this.int.call(
    { command: CommandType.EditHelper_Finish, withOffset: a || !0 },
    b
  );
};
AirCityAPI.EditHelper.prototype.setParam = function (a, b, c, e, d, l) {
  return this.int.call(
    {
      command: CommandType.EditHelper_SetParam,
      lineType: a,
      buildType: b,
      drawType: c,
      color: __convertColor(e),
      drawThickness: d,
    },
    l
  );
  ...
  return (function () {
  ...
  })()(
    {
      ...
      2: [
        function (a, b, c) {
          function e(h) {
            ...
            if (null != h)
              for (var t in h)
                Object.prototype.hasOwnProperty.call(h, t) && (q[t] = h[t]);
            q.default = h;
            return q;
          }
        ...
        function (a, b, c) {
          ...
          function d(f) {
            ...
            f.RTCPeerConnection.prototype.addTrack = function (x, u) {
              ...
              this._shimmedLocalStreams[u.id]
                ? -1 === this._shimmedLocalStreams[u.id].indexOf(z) &&
                this._shimmedLocalStreams[u.id].push(z)
                : (this._shimmedLocalStreams[u.id] = [u, z]);
              return z;
            };
            ...
            f.RTCPeerConnection.prototype.removeTrack = function (x) {
              ...
              x &&
                Object.keys(this._shimmedLocalStreams).forEach(function (z) {
                  ...
                  1 === u._shimmedLocalStreams[z].length &&
                    delete u._shimmedLocalStreams[z];
                });
          ...
          c.shimOnTrack = function (f) {
            if (
              "object" !== ("undefined" === typeof f ? "undefined" : l(f)) ||
              !f.RTCPeerConnection ||
              "ontrack" in f.RTCPeerConnection.prototype
            )
              k.wrapPeerConnectionEvent(f, "track", function (q) {
                q.transceiver ||
                  Object.defineProperty(q, "transceiver", {
                    value: { receiver: q.receiver },
                  });
                return q;
              });
            else {
          ...
          c.shimGetSendersWithDtmf = function (f) {
            if (
              "object" === ("undefined" === typeof f ? "undefined" : l(f)) &&
              f.RTCPeerConnection &&
              !("getSenders" in f.RTCPeerConnection.prototype) &&
              ...
              var h = function (z, m) {
                return {
                  ...
                  get dtmf() {
                    void 0 === this._dtmf &&
                      (this._dtmf =
                        "audio" === m.kind ? z.createDTMFSender(m) : null);
                    return this._dtmf;
                  },
                  _pc: z,
                };
              ...
              "createDTMFSender" in f.RTCPeerConnection.prototype &&
              f.RTCRtpSender &&
              !("dtmf" in f.RTCRtpSender.prototype)
            ) {
          ...
          c.shimSenderReceiverGetStats = function (f) {
            if (
              ...
              if (
                "getStats" in f.RTCRtpSender.prototype &&
                "getStats" in f.RTCRtpReceiver.prototype
              ) {
                var r = f.RTCPeerConnection.prototype.getStats;
                f.RTCPeerConnection.prototype.getStats = function () {
                  if (
                    0 < arguments.length &&
                    arguments[0] instanceof f.MediaStreamTrack
                  ) {
                    var x = arguments[0],
                      u = void 0,
                      z = void 0,
          ...
          c.shimAddTrackRemoveTrack = function (f) {
            ...
            if (f.RTCPeerConnection) {
              ...
              if (f.RTCPeerConnection.prototype.addTrack && 65 <= t.version)
                return d(f);
              ...
              f.RTCPeerConnection.prototype.removeStream = function (n) {
                ...
                delete this._reverseStreams[
                  this._streams[n.id] ? this._streams[n.id].id : n.id
                ];
              ...
              f.RTCPeerConnection.prototype.addTrack = function (n, w) {
                ...
                (A = this._streams[w.id])
                  ...
                  : ((A = new f.MediaStream([n])),
                    (this._streams[w.id] = A),
                    (this._reverseStreams[A.id] = w),
                    this.addStream(A));
              ...
              f.RTCPeerConnection.prototype.removeTrack = function (n) {
                ...
                y &&
                  (1 === y.getTracks().length
                    ? this.removeStream(this._reverseStreams[y.id])
          ...
          c.shimPeerConnection = function (f) {
            ...
            !f.RTCPeerConnection &&
              ...
              (f.RTCPeerConnection = f.webkitRTCPeerConnection);
            if (f.RTCPeerConnection) {
              var q =
                0 === f.RTCPeerConnection.prototype.addIceCandidate.length;
              53 > h.version &&
                [
                  "setLocalDescription",
          ...
          var k = (function (f) {
            ...
            if (null != f)
              for (var q in f)
                Object.prototype.hasOwnProperty.call(f, q) && (h[q] = f[q]);
            h.default = f;
            return h;
          })(a("../utils.js"));
        },
                  ...
                  return d(l).then(function (g) {
                    ...
                    l.video = {
                      mandatory: {
                        ...
                        maxFrameRate: (l.video && l.video.frameRate) || 3,
                      },
                    };
            ...
            if (p.mediaDevices) {
              var k = d.detectBrowser(g),
                f = function (r) {
                  if (
                    "object" !==
                    ("undefined" === typeof r ? "undefined" : e(r)) ||
                    r.mandatory ||
                    r.optional
                  )
                    return r;
                  ...
                  Object.keys(r).forEach(function (u) {
                    if (
                      ...
                      void 0 !== z.exact &&
                        "number" === typeof z.exact &&
                        (z.min = z.max = z.exact);
                      var m = function (w, y) {
                        return w
                          ? w + y.charAt(0).toUpperCase() + y.slice(1)
                          : "deviceId" === y
                            ? "sourceId"
                            : y;
                      };
                      ...
                      void 0 !== z.exact && "number" !== typeof z.exact
                        ? ((x.mandatory = x.mandatory || {}),
                          (x.mandatory[m("", u)] = z.exact))
                        : ["min", "max"].forEach(function (w) {
                          void 0 !== z[w] &&
                            ((x.mandatory = x.mandatory || {}),
                              (x.mandatory[m(w, u)] = z[w]));
                        });
                    }
                  });
                  r.advanced &&
                    (x.optional = (x.optional || []).concat(r.advanced));
                  return x;
                },
                h = function (r, x) {
                  ...
                  if (r && "object" === e(r.video)) {
                    ...
                    z =
                      z &&
                      ("object" ===
                        ("undefined" === typeof z ? "undefined" : e(z))
                        ? z
                        : { ideal: z });
                    u = 66 > k.version;
                    if (
                      !(
                        ...
                        ("user" !== z.exact &&
                          ...
                          "user" !== z.ideal &&
                          "environment" !== z.ideal) ||
                        (p.mediaDevices.getSupportedConstraints &&
                          p.mediaDevices.getSupportedConstraints().facingMode &&
                          !u)
                      )
                    ) {
                      ...
                      if (
                        ...
                        m = ["back", "rear"];
                      else if ("user" === z.exact || "user" === z.ideal)
                        m = ["front"];
                      if (m)
                        return p.mediaDevices
                          .enumerateDevices()
                          .then(function (n) {
                ...
                p.mediaDevices.getUserMedia = function (r) {
                  return h(r, function (x) {
                    return t(x).then(
                      function (u) {
                        if (
                          (x.audio && !u.getAudioTracks().length) ||
                          (x.video && !u.getVideoTracks().length)
                        )
                          throw (
                            (u.getTracks().forEach(function (z) {
                              z.stop();
                            }),
        ...
        function (a, b, c) {
          ...
          c.shimRTCIceCandidate = function (g) {
            if (
              g.RTCIceCandidate &&
              !(
                g.RTCIceCandidate && "foundation" in g.RTCIceCandidate.prototype
              )
            ) {
              var p = g.RTCIceCandidate;
              g.RTCIceCandidate = function (k) {
                "object" === ("undefined" === typeof k ? "undefined" : e(k)) &&
                  k.candidate &&
                  0 === k.candidate.indexOf("a=") &&
                  ((k = JSON.parse(JSON.stringify(k))),
                    (k.candidate = k.candidate.substr(2)));
                if (k.candidate && k.candidate.length) {
                  ...
                  h.toJSON = function () {
                    return {
                      ...
                      sdpMid: h.sdpMid,
                      sdpMLineIndex: h.sdpMLineIndex,
                      usernameFragment: h.usernameFragment,
                    };
                  };
                  return h;
                }
              ...
              l.wrapPeerConnectionEvent(g, "icecandidate", function (k) {
                k.candidate &&
                  Object.defineProperty(k, "candidate", {
            ...
            if (g.RTCPeerConnection) {
              ...
              var k = function (r) {
                ...
                return r.some(function (x) {
                  return (
                    (x = d.default.parseMLine(x)) &&
                    "application" === x.kind &&
                    -1 !== x.protocol.indexOf("SCTP")
                  );
                });
              },
                f = function (r) {
                ...
                q = function (r, x) {
                  ...
                  0 < r.length
                    ? (u = parseInt(r[0].substr(19), 10))
                    : "firefox" === p.browser && -1 !== x && (u = 2147483637);
                  return u;
                },
          ...
          c.shimSendThrowTypeError = function (g) {
            function p(f, h) {
              ...
              f.send = function () {
                ...
                if (
                  "open" === f.readyState &&
                  h.sctp &&
                  t > h.sctp.maxMessageSize
                )
                  throw new TypeError(
                    "Message too large (can send a maximum of " +
                    h.sctp.maxMessageSize +
                    " bytes)"
                  );
            ...
            if (
              g.RTCPeerConnection &&
              "createDataChannel" in g.RTCPeerConnection.prototype
            ) {
          ...
          c.shimConnectionState = function (g) {
            if (
              g.RTCPeerConnection &&
              !("connectionState" in g.RTCPeerConnection.prototype)
            ) {
                ...
                set: function (k) {
                  ...
                  k &&
                    this.addEventListener(
                      "connectionstatechange",
                      (this._onconnectionstatechange = k)
                    );
                },
                enumerable: !0,
                configurable: !0,
          ...
          c.removeAllowExtmapMixed = function (g) {
            if (g.RTCPeerConnection) {
              ...
              if (
                !(
                  ("chrome" === p.browser && 71 <= p.version) ||
                  ("safari" === p.browser && 605 <= p.version)
                )
              ) {
      ...
      7: [
        function (a, b, c) {
          ...
          c.shimPeerConnection = function (k) {
            ...
            !k.RTCRtpSender ||
              ...
              Object.defineProperty(k.RTCRtpSender.prototype, "dtmf", {
                get: function () {
                  void 0 === this._dtmf &&
                    ("audio" === this.track.kind
                      ? (this._dtmf = new k.RTCDtmfSender(this))
            ...
            k.RTCDtmfSender &&
              !k.RTCDTMFSender &&
              (k.RTCDTMFSender = k.RTCDtmfSender);
            var q = (0, p.default)(k, f.version);
            k.RTCPeerConnection = function (t) {
              t &&
                t.iceServers &&
                ((t.iceServers = (0, g.filterIceServers)(
                  t.iceServers,
                  f.version
                )),
                  l.log("ICE servers after filtering:", t.iceServers));
              return new q(t);
            };
          ...
          c.shimReplaceTrack = function (k) {
            !k.RTCRtpSender ||
              "replaceTrack" in k.RTCRtpSender.prototype ||
              (k.RTCRtpSender.prototype.replaceTrack =
                k.RTCRtpSender.prototype.setTrack);
          };
          var l = (function (k) {
            ...
            if (null != k)
              for (var h in k)
                Object.prototype.hasOwnProperty.call(k, h) && (f[h] = k[h]);
            f.default = k;
            return f;
          })(a("../utils")),
            g = a("./filtericeservers"),
            p =
              (a = a("rtcpeerconnection-shim")) && a.__esModule
                ? a
                : { default: a };
        },
        {
            ...
            return d.filter(function (p) {
              if (p && (p.urls || p.url)) {
                ...
                k = k.filter(function (h) {
                  return 0 === h.indexOf("stun:")
                    ? !1
                    : (h =
                      h.startsWith("turn") &&
                      !h.startsWith("turn:[") &&
                      h.includes("transport=udp")) && !g
                      ? (g = !0)
                      : h && !g;
                });
                delete p.url;
        ...
        function (a, b, c) {
          ...
          c.shimGetUserMedia = function (e) {
            ...
            var d = function (g) {
              return {
                name:
                  { PermissionDeniedError: "NotAllowedError" }[g.name] ||
                  g.name,
                message: g.message,
      ...
      11: [
        function (a, b, c) {
          ...
          c.shimPeerConnection = function (k) {
            ...
            if (
              "object" === ("undefined" === typeof k ? "undefined" : d(k)) &&
              (k.RTCPeerConnection || k.mozRTCPeerConnection)
            ) {
              !k.RTCPeerConnection &&
                k.mozRTCPeerConnection &&
                (k.RTCPeerConnection = k.mozRTCPeerConnection);
              53 > f.version &&
                [
                  "setLocalDescription",
                    ...
                    if (53 > f.version && !x)
                      try {
                        ...
                        z.forEach(function (n, w) {
                          z.set(
                            w,
                            Object.assign({}, n, { type: q[n.type] || n.type })
                          );
                        });
                      }
                    return z;
          ...
          c.shimSenderGetStats = function (k) {
            if (
              ...
              k.RTCPeerConnection &&
              k.RTCRtpSender &&
              !(k.RTCRtpSender && "getStats" in k.RTCRtpSender.prototype)
            ) {
          ...
          c.shimReceiverGetStats = function (k) {
            if (
              ...
              k.RTCPeerConnection &&
              k.RTCRtpSender &&
              !(k.RTCRtpSender && "getStats" in k.RTCRtpReceiver.prototype)
            ) {
          ...
          c.shimRTCDataChannel = function (k) {
            k.DataChannel &&
              !k.RTCDataChannel &&
              (k.RTCDataChannel = k.DataChannel);
          };
                ...
                (k.RTCPeerConnection.prototype.addTransceiver = function () {
                  ...
                  q &&
                    h.sendEncodings.forEach(function (x) {
                      if ("rid" in x && !/^[a-z0-9]{0,16}$/i.test(x.rid))
                        throw new TypeError("Invalid RID value provided.");
                      if (
                        "scaleResolutionDownBy" in x &&
                        !(1 <= parseFloat(x.scaleResolutionDownBy))
                      )
            ...
            if (
              ...
              f &&
                (k.RTCRtpSender.prototype.getParameters = function () {
                  ...
                  return "sendEncodings" in this
                    ? Object.assign({}, { encodings: this.sendEncodings }, h)
                    : h;
                });
            }
          };
              ...
              (e.navigator.mediaDevices.getDisplayMedia = function (l) {
                if (!l || !l.video)
                  return (
                    ...
                    (l.name = "NotFoundError"),
                    (l.code = 8),
                    Promise.reject(l)
                  );
                !0 === l.video
                  ? (l.video = { mediaSource: d })
                  : (l.video.mediaSource = d);
                return e.navigator.mediaDevices.getUserMedia(l);
              });
          };
        ...
        function (a, b, c) {
          ...
          c.shimGetUserMedia = function (l) {
            ...
            if (
              !(
                55 < g.version &&
                "autoGainControl" in p.mediaDevices.getSupportedConstraints()
              )
            ) {
              ...
              p.mediaDevices.getUserMedia = function (t) {
                "object" === ("undefined" === typeof t ? "undefined" : e(t)) &&
                  ...
                  ((t = JSON.parse(JSON.stringify(t))),
                    k(t.audio, "autoGainControl", "mozAutoGainControl"),
                    k(t.audio, "noiseSuppression", "mozNoiseSuppression"));
                return f(t);
              };
              ...
              if (l && l.prototype.applyConstraints) {
                ...
                l.prototype.applyConstraints = function (t) {
                  "audio" === this.kind &&
                    ...
                    ((t = JSON.parse(JSON.stringify(t))),
                      k(t, "autoGainControl", "mozAutoGainControl"),
                      k(t, "noiseSuppression", "mozNoiseSuppression"));
      ...
      14: [
        function (a, b, c) {
          function e(g) {
            return g && void 0 !== g.video
              ? Object.assign({}, g, { video: l.compactObject(g.video) })
              : g;
          }
          Object.defineProperty(c, "__esModule", { value: !0 });
          var d =
                ...
                g.RTCPeerConnection.prototype.addTrack = function (k) {
                  ...
                  q &&
                    q.forEach(function (r) {
                      f._localStreams
                        ? f._localStreams.includes(r) || f._localStreams.push(r)
                        : (f._localStreams = [r]);
                    });
            ...
            g.RTCPeerConnection = function (k, f) {
              if (k && k.iceServers) {
                for (var h = [], q = 0; q < k.iceServers.length; q++) {
                  ...
                  !t.hasOwnProperty("urls") && t.hasOwnProperty("url")
                    ? (l.deprecated("RTCIceServer.url", "RTCIceServer.urls"),
                      (t = JSON.parse(JSON.stringify(t))),
                      (t.urls = t.url),
                      delete t.url,
                      h.push(t))
                    : h.push(k.iceServers[q]);
                }
                k.iceServers = h;
              }
              return new p(k, f);
          ...
          c.shimCreateOfferLegacy = function (g) {
            ...
            g.RTCPeerConnection.prototype.createOffer = function (k) {
              if (k) {
                "undefined" !== typeof k.offerToReceiveAudio &&
                  (k.offerToReceiveAudio = !!k.offerToReceiveAudio);
                var f = this.getTransceivers().find(function (h) {
                  return "audio" === h.receiver.track.kind;
                });
                !1 === k.offerToReceiveAudio && f
                  ? "sendrecv" === f.direction
                    ? f.setDirection
                      ? f.setDirection("sendonly")
                      : (f.direction = "sendonly")
                    : "recvonly" === f.direction &&
                    (f.setDirection
                      ? f.setDirection("inactive")
                      : (f.direction = "inactive"))
                  : !0 !== k.offerToReceiveAudio ||
                  f ||
                  this.addTransceiver("audio");
                "undefined" !== typeof k.offerToReceiveVideo &&
                  (k.offerToReceiveVideo = !!k.offerToReceiveVideo);
                f = this.getTransceivers().find(function (h) {
                  return "video" === h.receiver.track.kind;
                });
                !1 === k.offerToReceiveVideo && f
                  ? "sendrecv" === f.direction
                    ? f.setDirection
                      ? f.setDirection("sendonly")
                      : (f.direction = "sendonly")
        ...
        function (a, b, c) {
          ...
          function l(h) {
            return "[object Object]" !== Object.prototype.toString.call(h)
              ...
              : Object.keys(h).reduce(function (q, t) {
                var r =
                  "[object Object]" ===
                  Object.prototype.toString.call(h[t]),
                  x = r ? l(h[t]) : h[t];
          ...
          c.wrapPeerConnectionEvent = function (h, q, t) {
            if (h.RTCPeerConnection) {
              ...
              Object.defineProperty(h, "on" + q, {
                ...
                set: function (u) {
                  this["_on" + q] &&
                    (this.removeEventListener(q, this["_on" + q]),
                      delete this["_on" + q]);
          ...
          c.disableLog = function (h) {
            return "boolean" !== typeof h
              ? Error(
                "Argument type: " +
                ("undefined" === typeof h ? "undefined" : p(h)) +
          ...
          c.disableWarnings = function (h) {
            ...
            f = !h;
            return (
              "adapter.js deprecation warnings " + (h ? "disabled" : "enabled")
            );
          };
          c.log = function () {
            "object" !==
          ...
          c.deprecated = function (h, q) {
            f &&
              console.warn(h + " is deprecated, please use " + q + " instead.");
          };
          c.detectBrowser = function (h) {
            var q = h.navigator,
              t = { browser: null, version: null };
            if ("undefined" === typeof h || !h.navigator)
              return (t.browser = "Not a browser."), t;
            q.mozGetUserMedia
              ? ((t.browser = "firefox"),
                (t.version = d(q.userAgent, /Firefox\/(\d+)\./, 1)))
              : q.webkitGetUserMedia ||
                (!1 === h.isSecureContext &&
                  h.webkitRTCPeerConnection &&
                  !h.RTCIceGatherer)
                ? ((t.browser = "chrome"),
                  (t.version = d(q.userAgent, /Chrom(e|ium)\/(\d+)\./, 2)))
                : q.mediaDevices && q.userAgent.match(/Edge\/(\d+).(\d+)$/)
                  ? ((t.browser = "edge"),
                    (t.version = d(q.userAgent, /Edge\/(\d+).(\d+)$/, 2)))
                  : h.RTCPeerConnection && q.userAgent.match(/AppleWebKit\/(\d+)\./)
                    ? ((t.browser = "safari"),
                      (t.version = d(q.userAgent, /AppleWebKit\/(\d+)\./, 1)),
                      (t.supportsUnifiedPlan =
                        h.RTCRtpTransceiver &&
                        "currentDirection" in h.RTCRtpTransceiver.prototype))
      ...
      16: [
        function (a, b, c) {
          function e(h, q, t, r, x) {
            ...
            q += f.writeDtlsParameters(
              h.dtlsTransport.getLocalParameters(),
              "offer" === t ? "actpass" : x || "active"
            );
            q += "a=mid:" + h.mid + "\r\n";
            q =
              h.rtpSender && h.rtpReceiver
                ? q + "a=sendrecv\r\n"
                : h.rtpSender
                  ? q + "a=sendonly\r\n"
                  : h.rtpReceiver
                    ...
                    : q + "a=inactive\r\n";
            h.rtpSender &&
              ((t = h.rtpSender._initialTrackId || h.rtpSender.track.id),
                (h.rtpSender._initialTrackId = t),
                (r = "msid:" + (r ? r.id : "-") + " " + t + "\r\n"),
                (q =
                  q +
                  ("a=" + r) +
                  ("a=ssrc:" + h.sendEncodingParameters[0].ssrc + " " + r)),
                h.sendEncodingParameters[0].rtx &&
                ((q +=
                  "a=ssrc:" + h.sendEncodingParameters[0].rtx.ssrc + " " + r),
                  (q +=
                    "a=ssrc-group:FID " +
                    h.sendEncodingParameters[0].ssrc +
                    " " +
                    h.sendEncodingParameters[0].rtx.ssrc +
                    "\r\n")));
            q +=
              "a=ssrc:" +
              h.sendEncodingParameters[0].ssrc +
            ...
            return h.filter(function (r) {
              if (r && (r.urls || r.url)) {
                ...
                x = x.filter(function (z) {
                  return 0 !== z.indexOf("turn:") ||
                    -1 === z.indexOf("transport=udp") ||
                    -1 !== z.indexOf("turn:[") ||
                    t
                    ? 0 === z.indexOf("stun:") &&
                    14393 <= q &&
            ...
            var t = { codecs: [], headerExtensions: [], fecMechanisms: [] },
              r = function (u, z) {
                ...
                for (var m = 0; m < z.length; m++)
                  if (z[m].payloadType === u || z[m].preferredPayloadType === u)
                    return z[m];
              },
              x = function (u, z, m, n) {
            ...
            h.codecs.forEach(function (u) {
              for (var z = 0; z < q.codecs.length; z++) {
                ...
                if (
                  ...
                  u.clockRate === m.clockRate &&
                  ("rtx" !== u.name.toLowerCase() ||
                    !u.parameters ||
                    !m.parameters.apt ||
                    x(u, m, h.codecs, q.codecs))
                ) {
                  m = JSON.parse(JSON.stringify(m));
                  m.numChannels = Math.min(u.numChannels, m.numChannels);
                  t.codecs.push(m);
                  m.rtcpFeedback = m.rtcpFeedback.filter(function (n) {
                    for (var w = 0; w < u.rtcpFeedback.length; w++)
                      if (
                        u.rtcpFeedback[w].type === n.type &&
                        u.rtcpFeedback[w].parameter === n.parameter
                      )
                        return !0;
                    return !1;
                  });
          ...
          function p(h, q) {
            var t = h.getRemoteCandidates().find(function (r) {
              return (
                q.foundation === r.foundation &&
                q.ip === r.ip &&
                q.port === r.port &&
                q.priority === r.priority &&
                q.protocol === r.protocol &&
                q.type === r.type
              );
            });
          ...
          b.exports = function (h, q) {
            function t(m, n) {
              n.addTrack(m);
              n.dispatchEvent(
                new h.MediaStreamTrackEvent("addtrack", { track: m })
              );
            }
            function r(m, n) {
              n.removeTrack(m);
              n.dispatchEvent(
                new h.MediaStreamTrackEvent("removetrack", { track: m })
              );
            }
            function x(m, n, w, y) {
            ...
            var u = function (m) {
              ...
              if (m.iceCandidatePoolSize)
                for (var y = m.iceCandidatePoolSize; 0 < y; y--)
                  this._iceGatherers.push(
                    new h.RTCIceGatherer({
            ...
            u.prototype._dispatchEvent = function (m, n) {
              if (
                !this._isClosed &&
                (this.dispatchEvent(n), "function" === typeof this["on" + m])
              )
                this["on" + m](n);
            };
            ...
            u.prototype._createTransceiver = function (m, n) {
              ...
              this.usingBundle && w
                ? ((m.iceTransport = this.transceivers[0].iceTransport),
                  (m.dtlsTransport = this.transceivers[0].dtlsTransport))
                : ((w = this._createIceAndDtlsTransports()),
                  (m.iceTransport = w.iceTransport),
                  (m.dtlsTransport = w.dtlsTransport));
            ...
            u.prototype.addTrack = function (m, n) {
              ...
              for (var w, y = 0; y < this.transceivers.length; y++)
                this.transceivers[y].track ||
                  this.transceivers[y].kind !== m.kind ||
                  (w = this.transceivers[y]);
            ...
            u.prototype.removeTrack = function (m) {
              ...
              if (!(m instanceof h.RTCRtpSender))
                throw new TypeError(
                  "Argument 1 of RTCPeerConnection.removeTrack does not implement interface RTCRtpSender."
                );
            ...
            u.prototype._createIceGatherer = function (m, n) {
              ...
              this.transceivers[m].bufferCandidates = function (A) {
                ...
                null !== w.transceivers[m].bufferedCandidateEvents &&
                  w.transceivers[m].bufferedCandidateEvents.push(A);
              };
              y.addEventListener(
                "localcandidate",
                ...
                y.onlocalcandidate = function (B) {
                  if (!(w.usingBundle && 0 < n)) {
                    ...
                    if ((B = !F || 0 === Object.keys(F).length)) {
                      if ("new" === y.state || "gathering" === y.state)
                        y.state = "completed";
                    } else
                    ...
                    F[C.candidate.sdpMLineIndex] = B
                      ? F[C.candidate.sdpMLineIndex] + "a=end-of-candidates\r\n"
                      : F[C.candidate.sdpMLineIndex] +
                      ("a=" + C.candidate.candidate + "\r\n");
                    w._localDescription.sdp =
                      f.getDescription(w._localDescription.sdp) + F.join("");
                    F = w.transceivers.every(function (L) {
                      return (
                        L.iceGatherer && "completed" === L.iceGatherer.state
                      );
                    });
                    "gathering" !== w.iceGatheringState &&
                      ((w.iceGatheringState = "gathering"),
                        w._emitGatheringStateChange());
            ...
            u.prototype._disposeIceAndDtlsTransports = function (m) {
              ...
              n &&
                (delete n.onlocalcandidate,
                  delete this.transceivers[m].iceGatherer);
              if ((n = this.transceivers[m].iceTransport))
                delete n.onicestatechange,
                  delete this.transceivers[m].iceTransport;
              if ((n = this.transceivers[m].dtlsTransport))
                delete n.ondtlsstatechange,
                  delete n.onerror,
                  delete this.transceivers[m].dtlsTransport;
            };
            u.prototype._transceive = function (m, n, w) {
              var y = l(m.localCapabilities, m.remoteCapabilities);
              n &&
                m.rtpSender &&
                ((y.encodings = m.sendEncodingParameters),
                  (y.rtcp = {
                    cname: f.localCName,
                    compound: m.rtcpParameters.compound,
                  }),
                  m.recvEncodingParameters.length &&
                  (y.rtcp.ssrc = m.recvEncodingParameters[0].ssrc),
                  m.rtpSender.send(y));
              w &&
                m.rtpReceiver &&
                0 < y.codecs.length &&
                ("video" === m.kind &&
                  ...
                  (y.encodings = m.recvEncodingParameters.length
                    ? m.recvEncodingParameters
                    : [{}]),
                  (y.rtcp = { compound: m.rtcpParameters.compound }),
                  m.rtcpParameters.cname &&
                  (y.rtcp.cname = m.rtcpParameters.cname),
                  m.sendEncodingParameters.length &&
                  (y.rtcp.ssrc = m.sendEncodingParameters[0].ssrc),
                  m.rtpReceiver.receive(y));
            };
            u.prototype.setLocalDescription = function (m) {
              var n = this;
              if (-1 === ["offer", "answer"].indexOf(m.type))
                return Promise.reject(
                  k("TypeError", 'Unsupported type "' + m.type + '"')
                );
              if (
                !g("setLocalDescription", m.type, n.signalingState) ||
                n._isClosed
              )
                return Promise.reject(
                  k(
              ...
              if ("offer" === m.type) {
                ...
                w.forEach(function (B, C) {
                  ...
                  if (
                    !(
                      (f.isRejected(B) &&
                        0 === f.matchPrefix(B, "a=bundle-only").length) ||
                      F.rejected
                    )
                  ) {
                    ...
                    (n.usingBundle && 0 !== C) ||
                      (n._gather(F.mid, C),
                        "new" === E.state &&
                        E.start(L, M, A ? "controlling" : "controlled"),
                        "new" === D.state && D.start(B));
                    C = l(H, I);
            ...
            u.prototype.setRemoteDescription = function (m) {
              ...
              if (
                !g("setRemoteDescription", m.type, n.signalingState) ||
                n._isClosed
              )
                return Promise.reject(
                  k(
              ...
              n.canTrickleIceCandidates = L
                ? 0 <= L.substr(14).split(" ").indexOf("trickle")
                : !1;
              A.forEach(function (E, D) {
                var H = f.splitLines(E),
                  ...
                  M =
                    f.isRejected(E) &&
                    0 === f.matchPrefix(E, "a=bundle-only").length,
                ...
                if (
                  ...
                  !M &&
                    ...
                    (n.transceivers[D] = n._createTransceiver(I, !0));
                  ...
                  if ("offer" !== m.type || M)
                    "answer" !== m.type ||
                      ...
                      ((G = n.transceivers[D]),
                        ...
                        (F && 0 !== D) ||
                        ("new" === I.state && I.start(O, S, "controlling"),
                          "new" === R.state && R.start(U)),
                        !l(
                          G.localCapabilities,
                          G.remoteCapabilities
                        ).codecs.filter(function (K) {
                        ...
                        !N || ("sendrecv" !== H && "sendonly" !== H)
                          ? delete G.rtpReceiver
                          : ((H = N.track),
                            J
                              ? (w[J.stream] ||
                                (w[J.stream] = new h.MediaStream()),
                                t(H, w[J.stream]),
                                y.push([H, N, w[J.stream]]))
                              : (w.default || (w.default = new h.MediaStream()),
                                t(H, w.default),
                                y.push([H, N, w.default]))));
                  else {
                    var G = n.transceivers[D] || n._createTransceiver(I);
                    G.mid = R;
                    G.iceGatherer ||
                      (G.iceGatherer = n._createIceGatherer(D, F));
                    Q.length &&
                    ...
                    if ("sendrecv" === H || "sendonly" === H) {
                      ...
                      var N =
                        G.rtpReceiver ||
                        new h.RTCRtpReceiver(G.dtlsTransport, I);
                      if (S) {
                        H = N.track;
                        if (!J || "-" !== J.stream)
                          if (J) {
              ...
              void 0 === n._dtlsRole &&
                (n._dtlsRole = "offer" === m.type ? "active" : "passive");
                ...
                : 0 < m.checking
                  ...
                  : 0 < m.disconnected
                    ...
                    : 0 < m.new
                      ...
                      : 0 < m.connected
                        ? (n = "connected")
                        : 0 < m.completed && (n = "completed");
              n !== this.iceConnectionState &&
                ((this.iceConnectionState = n),
                  (n = new Event("iceconnectionstatechange")),
              ...
              0 < m.failed
                ...
                : 0 < m.connecting
                  ...
                  : 0 < m.disconnected
                    ...
                    : 0 < m.new
                      ? (n = "new")
                      : 0 < m.connected && (n = "connected");
              n !== this.connectionState &&
                ((this.connectionState = n),
                  (n = new Event("connectionstatechange")),
            ...
            u.prototype.createOffer = function (m) {
              ...
              if (n._isClosed)
                return Promise.reject(
                  k("InvalidStateError", "Can not call createOffer after close")
                );
              ...
              if (m) {
                if (m.mandatory || m.optional)
                  throw new TypeError(
                    "Legacy mandatory/optional constraints not supported."
                  );
                void 0 !== m.offerToReceiveAudio &&
                  (w =
                    !0 === m.offerToReceiveAudio
                      ? 1
                      : !1 === m.offerToReceiveAudio
                        ? 0
                        : m.offerToReceiveAudio);
                void 0 !== m.offerToReceiveVideo &&
                  (y =
                    !0 === m.offerToReceiveVideo
                      ? 1
                      : !1 === m.offerToReceiveVideo
                        ? 0
                        : m.offerToReceiveVideo);
              }
              for (
                n.transceivers.forEach(function (B) {
                  "audio" === B.kind
                    ? (w--, 0 > w && (B.wantReceive = !1))
                    : "video" === B.kind &&
                    (y--, 0 > y && (B.wantReceive = !1));
                });
                0 < w || 0 < y;

              )
                0 < w && (n._createTransceiver("audio"), w--),
                  0 < y && (n._createTransceiver("video"), y--);
              var A = f.writeSessionBoilerplate(
                n._sdpSessionId,
              ...
              n.transceivers.forEach(function (B, C) {
                ...
                B.mid = E;
                B.iceGatherer ||
                  (B.iceGatherer = n._createIceGatherer(C, n.usingBundle));
                ...
                E.codecs.forEach(function (D) {
                  "H264" === D.name &&
                    void 0 === D.parameters["level-asymmetry-allowed"] &&
                  ...
                  B.remoteCapabilities &&
                    ...
                    B.remoteCapabilities.codecs.forEach(function (H) {
                      D.name.toLowerCase() === H.name.toLowerCase() &&
                        ...
                        (D.preferredPayloadType = H.payloadType);
                    });
                });
                E.headerExtensions.forEach(function (D) {
                  (
                    (B.remoteCapabilities &&
                      B.remoteCapabilities.headerExtensions) ||
                    []
                  ).forEach(function (H) {
                ...
                B.wantReceive &&
                  (B.rtpReceiver = new h.RTCRtpReceiver(B.dtlsTransport, L));
            ...
            u.prototype.createAnswer = function () {
              ...
              if (
                "have-remote-offer" !== m.signalingState &&
                "have-local-pranswer" !== m.signalingState
              )
                return Promise.reject(
                  k(
                    "InvalidStateError",
              ...
              var n = f.writeSessionBoilerplate(
                m._sdpSessionId,
                m._sdpSessionVersion++
              );
              m.usingBundle &&
                (n +=
                  "a=group:BUNDLE " +
                ...
                if (!(B + 1 > w))
                  if (A.rejected)
                    ...
                    if (A.stream) {
                      var C;
                      "audio" === A.kind
                        ? (C = A.stream.getAudioTracks()[0])
                        : "video" === A.kind &&
                        (C = A.stream.getVideoTracks()[0]);
                      C &&
                        15019 <= q &&
                        "video" === A.kind &&
                  ...
                  if (n._remoteDescription)
                    if (m && "" !== m.candidate) {
                      ...
                      if (F) {
                        ...
                        C =
                          0 < Object.keys(m.candidate).length
                            ? f.parseCandidate(m.candidate)
                            : {};
                        if (
                          ("tcp" === C.protocol &&
                            (0 === C.port || 9 === C.port)) ||
                          (C.component && 1 !== C.component)
                        )
                          return y();
                        if (
                          (0 === B ||
                          ...
                          return A(
                            k("OperationError", "Can not add ICE candidate")
                          );
                        A = m.candidate.trim();
                        0 === A.indexOf("a=") && (A = A.substr(2));
                        w = f.getMediaSections(n._remoteDescription.sdp);
                        w[B] +=
                          "a=" + (C.type ? A : "end-of-candidates") + "\r\n";
                        n._remoteDescription.sdp =
                          f.getDescription(n._remoteDescription.sdp) +
                          w.join("");
                      } else
                        return A(
                          k("OperationError", "Can not add ICE candidate")
                      ...
                      for (
                        B = 0;
                        B < n.transceivers.length &&
                        (n.transceivers[B].rejected ||
                          (n.transceivers[B].iceTransport.addRemoteCandidate(
                            {}
                          ),
                            (w = f.getMediaSections(n._remoteDescription.sdp)),
                            (w[B] += "a=end-of-candidates\r\n"),
                            (n._remoteDescription.sdp =
                              f.getDescription(n._remoteDescription.sdp) +
                              w.join("")),
                            !n.usingBundle));
            ...
            u.prototype.getStats = function (m) {
              if (m && m instanceof h.MediaStreamTrack) {
                ...
                this.transceivers.forEach(function (y) {
                  y.rtpSender && y.rtpSender.track === m
                    ? (n = y.rtpSender)
                    : y.rtpReceiver &&
                    y.rtpReceiver.track === m &&
                    (n = y.rtpReceiver);
                });
      ...
      17: [
        function (a, b, c) {
          ...
          e.parseCandidate = function (d) {
            d =
              0 === d.indexOf("a=candidate:")
                ? d.substring(12).split(" ")
                : d.substring(10).split(" ");
            for (
              var l = {
                foundation: d[0],
          ...
          e.writeCandidate = function (d) {
            ...
            "host" !== g &&
              ...
              d.relatedPort &&
              (l.push("raddr"),
                l.push(d.relatedAddress),
                l.push("rport"),
                l.push(d.relatedPort));
            d.tcpType &&
              "tcp" === d.protocol.toLowerCase() &&
              (l.push("tcptype"), l.push(d.tcpType));
            if (d.usernameFragment || d.ufrag)
              l.push("ufrag"), l.push(d.usernameFragment || d.ufrag);
          ...
          e.parseExtmap = function (d) {
            ...
            return {
              id: parseInt(d[0], 10),
              direction:
                0 < d[0].indexOf("/") ? d[0].split("/")[1] : "sendrecv",
              uri: d[1],
            };
          };
          e.writeExtmap = function (d) {
            return (
              "a=extmap:" +
              (d.id || d.preferredId) +
              (d.direction && "sendrecv" !== d.direction
                ? "/" + d.direction
                : "") +
              " " +
              d.uri +
          ...
          e.parseFmtp = function (d) {
            for (
              var l = {}, g = d.substr(d.indexOf(" ") + 1).split(";"), p = 0;
              p < g.length;
              p++
            )
              (d = g[p].trim().split("=")), (l[d[0].trim()] = d[1]);
            return l;
          };
            ...
            d.rtcpFeedback &&
              ...
              d.rtcpFeedback.forEach(function (p) {
                l +=
                  ...
                  " " +
                  p.type +
                  (p.parameter && p.parameter.length ? " " + p.parameter : "") +
                  "\r\n";
              });
            return l;
          };
          e.parseSsrcMedia = function (d) {
            var l = d.indexOf(" "),
              ...
              p = d.indexOf(":", l);
            -1 < p
              ? ((g.attribute = d.substr(l + 1, p - l - 1)),
                (g.value = d.substr(p + 1)))
              : (g.attribute = d.substr(l + 1));
            return g;
          };
          ...
          e.writeCryptoLine = function (d) {
            return (
              ...
              d.cryptoSuite +
              " " +
              ("object" === typeof d.keyParams
                ? e.writeCryptoKeyParams(d.keyParams)
                : d.keyParams) +
              (d.sessionParams ? " " + d.sessionParams.join(" ") : "") +
              "\r\n"
            );
          };
          ...
          e.getIceParameters = function (d, l) {
            ...
            return g && d
              ? { usernameFragment: g.substr(12), password: d.substr(10) }
              : null;
          };
          ...
          e.writeRtpDescription = function (d, l) {
            ...
            g +=
              l.codecs
                .map(function (k) {
                  return void 0 !== k.preferredPayloadType
                    ? k.preferredPayloadType
                    : k.payloadType;
                })
                .join(" ") + "\r\n";
            g += "c=IN IP4 0.0.0.0\r\n";
          ...
          e.parseRtpEncodingParameters = function (d) {
            ...
            g.codecs.forEach(function (r) {
              "RTX" === r.name.toUpperCase() &&
                ...
                ((r = {
                  ...
                  p &&
                  ((r = JSON.parse(JSON.stringify(r))),
                    (r.fec = { ssrc: h, mechanism: k ? "red+ulpfec" : "red" }),
                    l.push(r)));
            });
            ...
            t.length &&
              ((t =
                0 === t[0].indexOf("b=TIAS:")
                  ? parseInt(t[0].substr(7), 10)
                  : 0 === t[0].indexOf("b=AS:")
                    ? 950 * parseInt(t[0].substr(5), 10) - 16e3
                    : void 0),
          ...
          e.parseMsid = function (d) {
            ...
            if (1 === l.length)
              return (
                (d = l[0].substr(7).split(" ")), { stream: d[0], track: d[1] }
              );
            d = e
              .matchPrefix(d, "a=ssrc:")
              .map(function (g) {
            ...
            if (0 < d.length)
              return (d = d[0].value.split(" ")), { stream: d[0], track: d[1] };
          };
          e.parseSctpDescription = function (d) {
            ...
            if (0 < e.matchPrefix(d, "a=sctpmap:").length)
              return (
                (d = e.matchPrefix(d, "a=sctpmap:")[0].substr(10).split(" ")),
          ...
          e.writeSctpDescription = function (d, l) {
            ...
            void 0 !== l.maxMessageSize &&
              d.push("a=max-message-size:" + l.maxMessageSize + "\r\n");
            return d.join("");
          };
          ...
          e.writeMediaSection = function (d, l, g, p) {
            ...
            l += e.writeDtlsParameters(
              d.dtlsTransport.getLocalParameters(),
              "offer" === g ? "actpass" : "active"
            );
            l += "a=mid:" + d.mid + "\r\n";
            l = d.direction
              ? l + ("a=" + d.direction + "\r\n")
              : d.rtpSender && d.rtpReceiver
                ...
                : d.rtpSender
                  ...
                  : d.rtpReceiver
                    ...
                    : l + "a=inactive\r\n";
            d.rtpSender &&
              ((g = "msid:" + p.id + " " + d.rtpSender.track.id + "\r\n"),
                (l =
                  l +
                  ("a=" + g) +
                  ("a=ssrc:" + d.sendEncodingParameters[0].ssrc + " " + g)),
                d.sendEncodingParameters[0].rtx &&
                ((l +=
                  "a=ssrc:" + d.sendEncodingParameters[0].rtx.ssrc + " " + g),
                  (l +=
                    "a=ssrc-group:FID " +
                    d.sendEncodingParameters[0].ssrc +
                    " " +
                    d.sendEncodingParameters[0].rtx.ssrc +
                    "\r\n")));
            l +=
              "a=ssrc:" +
              d.sendEncodingParameters[0].ssrc +
          ...
          e.isValidSDP = function (d) {
            ...
            for (var l = 0; l < d.length; l++)
              if (2 > d[l].length || "=" !== d[l].charAt(1)) return !1;
            return !0;
          };
...
var WS_OPEN_STATE = 1,
  ...
  AirCityPlayer = function (a, b) {
    ...
    if ("object" == typeof b) {
      ...
      var e = b.domId;
      var d = b.showMarker;
      var l = b.showStartupInfo;
      this.onclose = b.onclose;
      b.apiOptions &&
        ((b.apiOptions.player = this),
          (this.aircityApi = new AirCityAPI(null, b.apiOptions)));
    } else
      1 < arguments.length &&
        "string" == typeof arguments[1] &&
        (e = arguments[1]),
        3 < arguments.length && (d = arguments[3]),
        4 < arguments.length && (l = arguments[4]);
    this.uniqueId = Date.now();
    if ((this.container = e ? document.getElementById(e) : null))
      (this.observer = new (window.MutationObserver ||
        window.WebKitMutationObserver ||
        window.MozMutationObserver)(function (g) {
          c.onResize();
        })),
        ...
        l &&
        ((this.startupInfoPanelVisible = l), this.createStartupInfoPanel()),
        (this.infoMarkerVisible = d),
    ...
    this.host = a;
    this.logStartupInfo("host: " + a);
    this.url =
      this.getProtocol() + "://" + a + "/?hasVideo=" + !!this.container;
    this.iid && (this.url += "&iid=" + this.iid);
    this.pid && (this.url += "&pid=" + this.pid);
    setTimeout(
      function () {
        this.connect();
      }.bind(this),
    ...
    setInterval(
      function () {
        var g = new Date(),
          p = g.getTime();
        g = g.getHours();
        108e5 < p - this.lastRefreshTimestamp &&
          3 < g &&
          5 > g &&
          ((this.lastRefreshTimestamp = p), this.setupWebRTCConnection());
      }.bind(this),
      36e5
    );
  };
AirCityPlayer.prototype.getProtocol = function () {
  return "https:" == location.protocol ? "wss" : "ws";
};
AirCityPlayer.prototype.getHost = function () {
  return this.host;
};
AirCityPlayer.prototype.getAPI = function () {
  return this.aircityApi;
};
...
AirCityPlayer.prototype.setResolution = function (a, b) {
  window.devicePixelRatio &&
    ((a *= window.devicePixelRatio), (b *= window.devicePixelRatio));
  if (3840 < a || 2160 < b)
    (b = a / b),
      b >= 3840 / 2160
        ? ((a = 3840), (b = 3840 / b))
  ...
  a = Math.floor(a);
  b = Math.floor(b);
  a = { Console: "setres " + a + "x" + b + "w" };
  this.sendMessage(MessageType.UIInteraction, a);
  console.log(a);
};
AirCityPlayer.prototype.sendByDataChannel = function (a) {
  this.dcClient && "open" == this.dcClient.readyState && this.dcClient.send(a);
};
AirCityPlayer.prototype.sendApiCommand = function (a) {
  a.__playerId = this.playerId;
  a = JSON.stringify(a);
  if (32766 < a.length) {
    for (var b = Math.ceil(a.length / 32766), c = [], e = 0; e < b; e++) {
      var d = 32766;
      e == b - 1 && (d = a.length - 32766 * e);
      c[e] = {
        type: 0 == e ? 1 : e == b - 1 ? 3 : 2,
        stringLength: d,
        content: a.substr(32766 * e, d),
      };
    }
    a = $jscomp.makeIterator(c);
    for (b = a.next(); !b.done; b = a.next()) {
      e = b.value;
      b = new DataView(new ArrayBuffer(4 + 2 * e.stringLength));
      c = 0;
      b.setUint8(c, MessageType.ApiCommand);
      c++;
      b.setUint8(c, e.type);
      c++;
      b.setUint16(c, e.stringLength, !0);
      c += 2;
      e = e.content;
      for (d = 0; d < e.length; d++)
        b.setUint16(c, e.charCodeAt(d), !0), (c += 2);
      this.sendByDataChannel(b.buffer);
    }
  } else {
    b = new DataView(new ArrayBuffer(4 + 2 * a.length));
    c = 0;
    b.setUint8(c, MessageType.ApiCommand);
    c++;
    b.setUint8(c, 0);
    c++;
    b.setUint16(c, a.length, !0);
    c += 2;
    for (e = 0; e < a.length; e++)
      b.setUint16(c, a.charCodeAt(e), !0), (c += 2);
    this.sendByDataChannel(b.buffer);
  }
};
AirCityPlayer.prototype.sendMessage = function (a, b) {
  b = JSON.stringify(b);
  ...
  this.sendByDataChannel(c.buffer);
};
AirCityPlayer.prototype.sendMouseMove = function (a, b, c, e) {
  ...
  e.setInt16(5, c.x, !0);
  e.setInt16(7, c.y, !0);
  this.sendByDataChannel(e.buffer);
};
AirCityPlayer.prototype.sendMouseDown = function (a, b, c) {
...
AirCityPlayer.prototype.sendMouseUp = function (a, b, c) {
  b = this.normalizeAndQuantizeUnsigned(b, c);
  c = new DataView(new ArrayBuffer(6));
...
AirCityPlayer.prototype.sendMouseWheel = function (a, b, c) {
  b = this.normalizeAndQuantizeUnsigned(b, c);
...
AirCityPlayer.prototype.onResize = function (a) {
  if (this.container) {
    ...
    if (
      this.bNeedReposUI ||
      !this.oldRect ||
      this.oldRect.width != this.rect.width ||
      this.oldRect.height != this.rect.height
    )
      (this.bNeedReposUI = !1),
        (this.oldRect = this.rect),
        this.playerInfoPanelMarker &&
        ((this.playerInfoPanelMarker.style.left = this.rect.left + 10 + "px"),
          (this.playerInfoPanelMarker.style.top =
            this.rect.bottom - 30 + "px")),
        this.playerInfoPanel &&
        ((this.playerInfoPanel.style.left = this.rect.left + 10 + "px"),
          (this.playerInfoPanel.style.top = this.rect.bottom - 250 + "px")),
        this.startupInfoPanel &&
        ((this.startupInfoPanel.style.left = this.rect.left + "px"),
          (this.startupInfoPanel.style.top = this.rect.top + "px"),
          (this.startupInfoPanel.style.height = this.rect.height - 20 + "px")),
        this.video && this.autoAdjustResolution && this.updateVideoStreamSize();
    if (this.video) {
      a = this.container.clientHeight / this.container.clientWidth;
      var b = this.video.videoHeight / this.video.videoWidth;
      if (a > b) {
        var c = a / b;
        ...
        this.normalizeAndQuantizeSigned = function (d, l) {
          return {
            x: (d / (0.5 * this.container.clientWidth)) * 32767,
            y: ((c * l) / (0.5 * this.container.clientHeight)) * 32767,
          };
        }.bind(this);
      } else {
        var e = b / a;
        ...
        this.normalizeAndQuantizeSigned = function (d, l) {
          return {
            x: ((e * d) / (0.5 * this.container.clientWidth)) * 32767,
            y: (l / (0.5 * this.container.clientHeight)) * 32767,
          };
        }.bind(this);
      }
    }
...
AirCityPlayer.prototype.updateVideoStreamSize = function () {
  1e3 < new Date().getTime() - this.lastResizeTime
    ? (this.setResolution(
    ...
    : (clearTimeout(this.resizeTimerId),
      (this.resizeTimerId = setTimeout(
        this.updateVideoStreamSize.bind(this),
        1e3
      )));
};
AirCityPlayer.prototype.registerKeyboardEvents = function () {
  this.isFKey = function (a) {
    return 112 <= a.keyCode && 123 >= a.keyCode;
  };
  this.getKeyCode = function (a) {
    return a.keyCode === SpecialKeyCodes.Shift && "ShiftRight" === a.code
      ? SpecialKeyCodes.RightShift
      : a.keyCode === SpecialKeyCodes.Control && "ControlRight" === a.code
        ? SpecialKeyCodes.RightControl
        : a.keyCode === SpecialKeyCodes.Alt && "AltRight" === a.code
          ? SpecialKeyCodes.RightAlt
          : a.keyCode;
  };
  document.onkeydown = function (a) {
    this.isFKey(a) ||
      a.ctrlKey ||
      this.sendByDataChannel(
        new Uint8Array([MessageType.KeyDown, this.getKeyCode(a), a.repeat])
          .buffer
      );
    if (a.keyCode === SpecialKeyCodes.BackSpace)
  ...
  document.onkeyup = function (a) {
    this.isFKey(a) ||
      a.ctrlKey ||
      this.sendByDataChannel(
        new Uint8Array([MessageType.KeyUp, this.getKeyCode(a)]).buffer
      );
  }.bind(this);
...
AirCityPlayer.prototype.registerMouseEvents = function () {
  this.setCursor = function (a) {
    this &&
      this.container &&
      (this.container.style.cursor = a || 'url("cursors/point.cur"),auto');
  };
  ...
  this.container.onmousedown = function (a) {
    ...
    this.sendMouseDown(a.button, a.offsetX, a.offsetY);
    a.preventDefault();
  }.bind(this);
  ...
  this.container.oncontextmenu = function (a) {
    this.isMac || this.sendMouseUp(a.button, a.offsetX, a.offsetY);
    a.preventDefault();
  }.bind(this);
  ...
  this.container.pressMouseButtons = function (a) {
    var b = a.buttons,
      c = a.offsetX;
    a = a.offsetY;
    b & MouseButtonsMask.PrimaryButton &&
      this.sendMouseDown(MouseButton.MainButton, c, a);
    b & MouseButtonsMask.SecondaryButton &&
      this.sendMouseDown(MouseButton.SecondaryButton, c, a);
    b & MouseButtonsMask.AuxiliaryButton &&
      this.sendMouseDown(MouseButton.AuxiliaryButton, c, a);
    b & MouseButtonsMask.FourthButton &&
      this.sendMouseDown(MouseButton.FourthButton, c, a);
    b & MouseButtonsMask.FifthButton &&
      this.sendMouseDown(MouseButton.FifthButton, c, a);
  }.bind(this);
  this.container.releaseMouseButtons = function (a) {
    ...
    a = a.offsetY;
    b & MouseButtonsMask.PrimaryButton &&
      this.sendMouseUp(MouseButton.MainButton, c, a);
    b & MouseButtonsMask.SecondaryButton &&
      this.sendMouseUp(MouseButton.SecondaryButton, c, a);
    b & MouseButtonsMask.AuxiliaryButton &&
      this.sendMouseUp(MouseButton.AuxiliaryButton, c, a);
    b & MouseButtonsMask.FourthButton &&
      this.sendMouseUp(MouseButton.FourthButton, c, a);
    b & MouseButtonsMask.FifthButton &&
      this.sendMouseUp(MouseButton.FifthButton, c, a);
  }.bind(this);
};
AirCityPlayer.prototype.registerTouchEvents = function () {
  ...
  this.rememberTouch = function (b) {
    ...
    void 0 === c && console.log("exhausted touch indentifiers");
  ...
  this.sendTouchData = function (b, c) {
    ...
    for (var d = 0; d < c.length; d++) {
      var l = c[d],
        g = this.normalizeAndQuantizeUnsigned(
          l.clientX - this.container.offsetLeft,
          l.clientY - this.container.offsetTop
        );
      e.setUint16(b, g.x, !0);
      b += 2;
      e.setUint16(b, g.y, !0);
  ...
  if (this.fakeMouseWithTouches) {
    ...
    this.container.ontouchstart = function (b) {
      if (void 0 === a) {
        ...
        a = {
          id: c.identifier,
          x: c.clientX - this.rect.left,
          y: c.clientY - this.rect.top,
        };
        this.container.onmouseenter(b);
        this.sendMouseDown(MouseButton.MainButton, a.x, a.y);
      }
      b.preventDefault();
    }.bind(this);
    ...
    this.container.ontouchmove = function (b) {
      for (var c = 0; c < b.touches.length; c++) {
        var e = b.touches[c];
        if (e.identifier === a.id) {
          c = e.clientX - this.rect.left;
          e = e.clientY - this.rect.top;
          this.sendMouseMove(c, e, c - a.x, e - a.y);
          a.x = c;
          a.y = e;
          break;
        }
    ...
    (this.container.ontouchstart = function (b) {
      for (var c = 0; c < b.changedTouches.length; c++)
        this.rememberTouch(b.changedTouches[c]);
      this.sendTouchData(MessageType.TouchStart, b.changedTouches);
      b.preventDefault();
    }.bind(this)),
      (this.container.ontouchend = function (b) {
        this.sendTouchData(MessageType.TouchEnd, b.changedTouches);
        for (var c = 0; c < b.changedTouches.length; c++)
          this.forgetTouch(b.changedTouches[c]);
        b.preventDefault();
      }.bind(this)),
      (this.container.ontouchmove = function (b) {
        this.sendTouchData(MessageType.TouchMove, b.touches);
        b.preventDefault();
      }.bind(this));
};
...
AirCityPlayer.prototype.showStartupInfoPanel = function (a) {
  a && this.startupInfoPanel && (this.startupInfoPanel.innerText = "");
  this.startupInfoPanelVisible != a &&
    this.startupInfoPanel &&
    ((this.startupInfoPanelVisible = a),
      (this.startupInfoPanel.style.display = a ? "block" : "none"),
      (this.bNeedReposUI = !0),
      this.onResize());
};
AirCityPlayer.prototype.logStartupInfo = function (a) {
  this.startupInfoPanel &&
    ((this.startupInfoPanel.innerText += a + "\n"),
      (this.startupInfoPanel.scrollTop =
        this.startupInfoPanel.scrollHeight + 100));
  this.aircityApi && this.aircityApi.log(a);
};
AirCityPlayer.prototype.createPlayerInfoMarker = function () {
  if (!this.playerInfoPanelMarker) {
    ...
    this.playerInfoPanelMarker.title = this.nodeInfoArray.join("\n");
...
AirCityPlayer.prototype.showHideInfoPanel = function () {
  this.playerInfoPanel
    ? "none" == this.playerInfoPanel.style.display
      ? (this.updateKickButton(),
        (this.playerInfoPanel.style.display = "block"),
        (this.isInfoPanelVisible = !0),
        this.onResize(),
        (this.playerInfoPanelMarker.innerText =
          "\uff0d\u9690\u85cf\u4fe1\u606f"))
      : ((this.isInfoPanelVisible = !1),
        (this.playerInfoPanel.style.display = "none"),
        (this.playerInfoPanelMarker.innerText =
          "\uff0b\u663e\u793a\u4fe1\u606f"))
    : (this.createPlayerInfoPanel(),
      (this.isInfoPanelVisible = !0),
      this.onResize(),
      (this.playerInfoPanelMarker.innerText = "\uff0d\u9690\u85cf\u4fe1\u606f"),
      this.updateKickButton());
  this.bNeedReposUI = !0;
  this.onResize();
};
...
AirCityPlayer.prototype.updateKickButton = function (a) {
  ...
  if (
    (a = document.getElementById("playerInfoConnectionCount_" + this.uniqueId))
  )
    a.innerText = this.playersCount;
  this.autoAdjustResolution &&
    (this.enableAutoAdjustResolution(1 == this.playersCount), this.onResize());
};
      ...
      "inbound-rtp" != h.type ||
        ...
        ((b.timestamp = h.timestamp),
          ...
          (b.bytesReceivedStart =
            this.stats && this.stats.bytesReceivedStart
              ? this.stats.bytesReceivedStart
              : h.bytesReceived),
          (b.framesDecodedStart =
            this.stats && this.stats.framesDecodedStart
              ? this.stats.framesDecodedStart
              : h.framesDecoded),
          (b.timestampStart =
            this.stats && this.stats.timestampStart
              ? this.stats.timestampStart
              : h.timestamp),
          this.stats &&
          this.stats.timestamp &&
          (this.stats.bytesReceived &&
            ((b.bitrate =
              (8 * (b.bytesReceived - this.stats.bytesReceived)) /
              (b.timestamp - this.stats.timestamp)),
              (b.bitrate = Math.floor(b.bitrate)),
              (b.lowBitrate =
                this.stats.lowBitrate && this.stats.lowBitrate < b.bitrate
                  ? this.stats.lowBitrate
                  : b.bitrate),
              (b.highBitrate =
                this.stats.highBitrate && this.stats.highBitrate > b.bitrate
                  ? this.stats.highBitrate
                  : b.bitrate)),
            this.stats.bytesReceivedStart &&
            ((b.avgBitrate =
              (8 * (b.bytesReceived - this.stats.bytesReceivedStart)) /
              (b.timestamp - this.stats.timestampStart)),
              (b.avgBitrate = Math.floor(b.avgBitrate))),
            this.stats.framesDecoded &&
            ((b.framerate =
              (b.framesDecoded - this.stats.framesDecoded) /
              ((b.timestamp - this.stats.timestamp) / 1e3)),
              (b.framerate = Math.floor(b.framerate)),
              (b.lowFramerate =
                this.stats.lowFramerate && this.stats.lowFramerate < b.framerate
                  ? this.stats.lowFramerate
                  : b.framerate),
              (b.highFramerate =
                this.stats.highFramerate && this.stats.highFramerate > b.framerate
                  ? this.stats.highFramerate
                  : b.framerate)),
            this.stats.framesDecodedStart &&
            ((b.avgframerate =
              (b.framesDecoded - this.stats.framesDecodedStart) /
              ((b.timestamp - this.stats.timestampStart) / 1e3)),
              (b.avgframerate = Math.floor(b.avgframerate)))));
      "track" == h.type &&
        h.frameWidth &&
        ((b.framesDropped = h.framesDropped),
          (b.framesReceived = h.framesReceived),
          (b.framesDroppedPercentage =
            (h.framesDropped / h.framesReceived) * 100),
          (b.frameHeight = h.frameHeight),
          (b.frameWidth = h.frameWidth),
          (b.frameHeightStart =
            this.stats && this.stats.frameHeightStart
              ? this.stats.frameHeightStart
              : h.frameHeight),
          (b.frameWidthStart =
            this.stats && this.stats.frameWidthStart
              ? this.stats.frameWidthStart
              : h.frameWidth));
      "candidate-pair" == h.type &&
        h.hasOwnProperty("currentRoundTripTime") &&
        0 != h.currentRoundTripTime &&
        (b.currentRoundTripTime = h.currentRoundTripTime);
    }.bind(this)
  );
  this.stats = b;
  1e5 <
    (this.stats.hasOwnProperty("bytesReceived")
      ? this.stats.bytesReceived
      : 0) && this.showStartupInfoPanel(!1);
  if (this.isInfoPanelVisible) {
    a = new Intl.NumberFormat(window.navigator.language, {
      maximumFractionDigits: 0,
    });
    for (
      var c = new Intl.NumberFormat(window.navigator.language, {
        maximumFractionDigits: 0,
        minimumIntegerDigits: 2,
      }),
      e = (this.stats.timestamp - this.stats.timestampStart) / 1e3,
      d = [],
      l = [60, 60],
      g = 0;
      g < l.length;
    ...
    g = "B";
    for (
      var p = this.stats.hasOwnProperty("bytesReceived")
        ? this.stats.bytesReceived
        : 0,
      k = ["kB", "MB", "GB"],
      f = 0;
      ...
      (p /= 1e3), (g = k[f]);
    document.getElementById("playerInfoDuration_" + this.uniqueId).innerText =
      c.format(d) + ":" + c.format(l) + ":" + c.format(e);
    document.getElementById("playerInfoResolution_" + this.uniqueId).innerText =
      this.stats.hasOwnProperty("frameWidth") &&
        this.stats.frameWidth &&
        this.stats.hasOwnProperty("frameHeight") &&
        this.stats.frameHeight
        ? this.stats.frameWidth + "x" + this.stats.frameHeight
        : "N/A";
    document.getElementById("playerInfoReceived_" + this.uniqueId).innerText =
      a.format(p) + " " + g;
    document.getElementById(
      "playerInfoFramesDecoded_" + this.uniqueId
    ).innerText =
      "" +
      (this.stats.hasOwnProperty("framesDecoded")
        ? a.format(this.stats.framesDecoded)
        : "N/A");
    document.getElementById(
      "playerInfoPacketsLost_" + this.uniqueId
    ).innerText =
      "" +
      (this.stats.hasOwnProperty("packetsLost")
        ? a.format(this.stats.packetsLost)
        : "N/A");
    document.getElementById("playerInfoBitrate_" + this.uniqueId).innerText =
      "" +
      (this.stats.hasOwnProperty("bitrate")
        ? a.format(this.stats.bitrate)
        : "N/A");
    document.getElementById("playerInfoFramerate_" + this.uniqueId).innerText =
      "" +
      (this.stats.hasOwnProperty("framerate")
        ? a.format(this.stats.framerate)
        : "N/A");
    document.getElementById(
      "playerInfoFramesDropped_" + this.uniqueId
    ).innerText =
      "" +
      (this.stats.hasOwnProperty("framesDropped")
        ? a.format(this.stats.framesDropped)
        : "N/A");
  }
};
AirCityPlayer.prototype.initWebRTCVars = function (a) {
  ...
  this.container || (this.sdpConstraints.offerToReceiveVideo = 0);
...
AirCityPlayer.prototype.refreshWebRTCState = function () {
  this.signalingState != this.pcClient.signalingState &&
    ((this.signalingState = this.pcClient.signalingState),
      this.logStartupInfo("---signalingState: " + this.signalingState));
  this.iceConnectionState != this.pcClient.iceConnectionState &&
    ((this.iceConnectionState = this.pcClient.iceConnectionState),
      this.logStartupInfo("---iceConnectionState: " + this.iceConnectionState),
      "disconnected" == this.iceConnectionState &&
      this.logStartupInfo(
        "\u8fde\u63a5\u5efa\u7acb\u5931\u8d25\uff0c\u8bf7\u68c0\u67e5\u670d\u52a1\u5668\u7aef\u53e3\u8bbe\u7f6e"
      ),
      "failed" == this.iceConnectionState &&
      this.logStartupInfo(
        "\u8fde\u63a5\u5efa\u7acb\u5931\u8d25\uff0c\u65e0\u53ef\u7528\u7684\u5019\u9009\u8fde\u63a5"
      ));
  this.iceGatheringState != this.pcClient.iceGatheringState &&
    ((this.iceGatheringState = this.pcClient.iceGatheringState),
      this.logStartupInfo("---iceGatheringState: " + this.iceGatheringState));
};
AirCityPlayer.prototype.setupWebRTCConnection = function () {
  ...
  this.pcClient.ontrack = function (b) {
    this.container &&
      this.video.srcObject !== b.streams[0] &&
      (this.video.srcObject = b.streams[0]);
  }.bind(this);
  this.pcClient.onicecandidate = function (b) {
    b.candidate &&
      ...
      this.ws.send(
        JSON.stringify({ type: "iceCandidate", candidate: b.candidate })
      );
  }.bind(this);
  try {
    ...
    a.onopen = function (b) {
      ...
      if (this.aircityApi) this.aircityApi.onConnectionOpen();
    }.bind(this);
    a.onclose = function (b) {
      this.logStartupInfo("data channel closed");
      if (this.aircityApi) this.aircityApi.onConnectionClose(b);
    }.bind(this);
    a.onmessage = function (b) {
      1 === new Uint8Array(b.data)[0] &&
        this.aircityApi &&
        (b = new TextDecoder("utf-16").decode(b.data.slice(1))) &&
        "" != b &&
        this.aircityApi.onConnectionMessage(b);
    }.bind(this);
    this.dcClient = a;
  } catch (b) {
  ...
  this.pcClient.createOffer(this.sdpConstraints).then(
    function (b) {
      ...
      b.sdp = b.sdp.replace(
        ...
        "$1;x-google-start-bitrate=15000;x-google-max-bitrate=" +
        (this.maxBitrate || 3e4) +
        "\r\n"
      );
      ...
      this.ws &&
        this.ws.readyState === WS_OPEN_STATE &&
        ((b = JSON.stringify(b)), this.ws.send(b));
    }.bind(this),
    function () {
...
AirCityPlayer.prototype.onWebRTCConfig = function (a) {
    ...
    (this.logStartupInfo("create video element"),
      ...
      this.video.addEventListener(
        ...
        function (b) {
          this.ws &&
            this.ws.readyState === WS_OPEN_STATE &&
            (this.container.onmouseenter({ button: 0, x: 0, y: 0 }),
              this.infoMarkerVisible && this.createPlayerInfoMarker(),
              this.onResize());
        }.bind(this),
        !0
      ),
...
AirCityPlayer.prototype.onWebRTCAnswer = function (a) {
  this.playerId = a.playerId;
  this.logStartupInfo("received server answer: " + this.playerId);
...
AirCityPlayer.prototype.onSignallingServerMessage = function (a) {
  a = JSON.parse(a.data);
  switch (a.type) {
    case "config":
      this.onWebRTCConfig(a);
      break;
    case "playerCount":
      this.updateKickButton(a.count);
      break;
    case "answer":
      this.onWebRTCAnswer(a);
      break;
    case "iceCandidate":
      a = new RTCIceCandidate(a.candidate);
      this.pcClient.addIceCandidate(a).then(function () { });
      break;
    case "paramInfo":
      var b = a.project,
        c = a.nodeIP,
        e = a.hostName;
      this.iid || (this.iid = a.iid);
      (this.pid && -1 != this.pid) || (this.pid = a.pid);
      this.nodeInfoArray = ["Node Information:"];
      e && this.nodeInfoArray.push("HOST: " + e);
      c && this.nodeInfoArray.push("NODE: " + c);
      b && this.nodeInfoArray.push("PROJECT: " + b);
      this.pid && this.nodeInfoArray.push("PID: " + this.pid);
      this.iid && this.nodeInfoArray.push("IID: " + this.iid);
      this.aircityApi && this.aircityApi.log(this.nodeInfoArray.join("\n\t"));
      break;
    case "status":
      this.logStartupInfo(a.info);
  }
};
AirCityPlayer.prototype.onSignallingServerClose = function (a) {
  if (this.onclose) this.onclose(a);
  if (this.aircityApi) this.aircityApi.onConnectionClose(a);
  this.showStartupInfoPanel(!0);
  ...
  window.WebSocket
    ? (this.logStartupInfo("connecting..."),
      ...
      (this.ws.onmessage = function (a) {
        this.onSignallingServerMessage(a);
      }.bind(this)),
      ...
      (this.ws.onclose = function (a) {
        this.onSignallingServerClose(a);
      }.bind(this)))
...
AirCityPlayer.prototype.destroy = function () {
  ...
  this.video &&
    (this.closeWebRTC(),
      ...
      (this.video = null));
  this.playerInfoPanel &&
    (document.body.removeChild(this.playerInfoPanel),
      (this.playerInfoPanel = null));
  this.playerInfoPanelMarker &&
    (document.body.removeChild(this.playerInfoPanelMarker),
      (this.playerInfoPanelMarker = null));
  this.ws && (this.ws.close(), (this.ws = null));
};
"undefined" == typeof acapi
  ? (acapi = { AirCityPlayer: AirCityPlayer })
  : (acapi.AirCityPlayer = AirCityPlayer);
"undefined" != typeof module && module.exports
  ? (module.exports = acapi)
  : "function" == typeof define && define.amd
